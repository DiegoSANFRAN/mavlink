...
Generated from: ('ivaq_mvk.xml,minimal.xml',)
...
enums["MVK_RX_MODE"] = {}
MVK_MODE_1 = 0
enums["MVK_RX_MODE"][0] = EnumEntry("MVK_MODE_1", """PCB Mode 1""")
MVK_MODE_2 = 1
enums["MVK_RX_MODE"][1] = EnumEntry("MVK_MODE_2", """PCB Mode 2""")
MVK_MODE_3 = 2
enums["MVK_RX_MODE"][2] = EnumEntry("MVK_MODE_3", """PCB Mode 3""")
MVK_RX_MODE_ENUM_END = 3
enums["MVK_RX_MODE"][3] = EnumEntry("MVK_RX_MODE_ENUM_END", """""")

# MVK_RX_STATUS
enums["MVK_RX_STATUS"] = {}
MVK_POWER_OFF = 0
enums["MVK_RX_STATUS"][0] = EnumEntry("MVK_POWER_OFF", """Power off""")
MVK_POWER_ON = 1
enums["MVK_RX_STATUS"][1] = EnumEntry("MVK_POWER_ON", """Power on""")
MVK_POWER_ON_LOW_BATT = 2
enums["MVK_RX_STATUS"][2] = EnumEntry("MVK_POWER_ON_LOW_BATT", """Power on with low battery""")
MVK_POWER_ON_ERROR_COMMS = 3
enums["MVK_RX_STATUS"][3] = EnumEntry("MVK_POWER_ON_ERROR_COMMS", """Power on with communication error""")
MVK_RX_STATUS_ENUM_END = 4
enums["MVK_RX_STATUS"][4] = EnumEntry("MVK_RX_STATUS_ENUM_END", """""")

# MVK_RX_ANLG_EN
enums["MVK_RX_ANLG_EN"] = {}
MVK_VEN_FALSE = 0
enums["MVK_RX_ANLG_EN"][0] = EnumEntry("MVK_VEN_FALSE", """PCB Analog Part disable""")
MVK_VEN_TRUE = 1
enums["MVK_RX_ANLG_EN"][1] = EnumEntry("MVK_VEN_TRUE", """PCB Analog Part enable""")
MVK_RX_ANLG_EN_ENUM_END = 2
enums["MVK_RX_ANLG_EN"][2] = EnumEntry("MVK_RX_ANLG_EN_ENUM_END", """""")

# MVK_ANT_STATES
enums["MVK_ANT_STATES"] = {}
MVK_ANT_1_OFF = 0
enums["MVK_ANT_STATES"][0] = EnumEntry("MVK_ANT_1_OFF", """Antenna 1 off""")
MVK_ANT_1_ON = 1
enums["MVK_ANT_STATES"][1] = EnumEntry("MVK_ANT_1_ON", """Antenna 1 on""")
MVK_ANT_STATES_ENUM_END = 2
enums["MVK_ANT_STATES"][2] = EnumEntry("MVK_ANT_STATES_ENUM_END", """""")

# MVK_STAGE_STATES
enums["MVK_STAGE_STATES"] = {}
MVK_STAGE_1_OFF_STAGE_2_OFF_STAGE_3_OFF_STAGE_4_OFF = 0
enums["MVK_STAGE_STATES"][0] = EnumEntry("MVK_STAGE_1_OFF_STAGE_2_OFF_STAGE_3_OFF_STAGE_4_OFF", """Stage 1 off, Stage 2 off, Stage 3 off, Stage 4 off""")
MVK_STAGE_1_ON_STAGE_2_OFF_STAGE_3_OFF_STAGE_4_OFF = 1
enums["MVK_STAGE_STATES"][1] = EnumEntry("MVK_STAGE_1_ON_STAGE_2_OFF_STAGE_3_OFF_STAGE_4_OFF", """Stage 1 on, Stage 2 off, Stage 3 off, Stage 4 off""")
MVK_STAGE_1_ON_STAGE_2_ON_STAGE_3_OFF_STAGE_4_OFF = 2
enums["MVK_STAGE_STATES"][2] = EnumEntry("MVK_STAGE_1_ON_STAGE_2_ON_STAGE_3_OFF_STAGE_4_OFF", """Stage 1 on, Stage 2 on, Stage 3 off, Stage 4 off""")
MVK_STAGE_1_ON_STAGE_2_ON_STAGE_3_ON_STAGE_4_OFF = 3
enums["MVK_STAGE_STATES"][3] = EnumEntry("MVK_STAGE_1_ON_STAGE_2_ON_STAGE_3_ON_STAGE_4_OFF", """Stage 1 on, Stage 2 on, Stage 3 on, Stage 4 off""")
MVK_STAGE_1_ON_STAGE_2_ON_STAGE_3_ON_STAGE_4_ON = 4
enums["MVK_STAGE_STATES"][4] = EnumEntry("MVK_STAGE_1_ON_STAGE_2_ON_STAGE_3_ON_STAGE_4_ON", """Stage 1 on, Stage 2 on, Stage 3 on, Stage 4 on""")
MVK_STAGE_STATES_ENUM_END = 5
enums["MVK_STAGE_STATES"][5] = EnumEntry("MVK_STAGE_STATES_ENUM_END", """""")

# MVK_CARD_STATE
enums["MVK_CARD_STATE"] = {}
MVK_CARD_NOT_PRESENT = 0
enums["MVK_CARD_STATE"][0] = EnumEntry("MVK_CARD_NOT_PRESENT", """Save false""")
MVK_CARD_PRESENT = 1
enums["MVK_CARD_STATE"][1] = EnumEntry("MVK_CARD_PRESENT", """Save push button on""")
MVK_CARD_STATE_ENUM_END = 2
enums["MVK_CARD_STATE"][2] = EnumEntry("MVK_CARD_STATE_ENUM_END", """""")

# MVK_SAVE_STATE
enums["MVK_SAVE_STATE"] = {}
MVK_SAVE_FALSE = 0
enums["MVK_SAVE_STATE"][0] = EnumEntry("MVK_SAVE_FALSE", """Save false""")
MVK_SAVE_ACQ = 1
enums["MVK_SAVE_STATE"][1] = EnumEntry("MVK_SAVE_ACQ", """Save acquisition""")
MVK_SAVE_2_SD = 2
enums["MVK_SAVE_STATE"][2] = EnumEntry("MVK_SAVE_2_SD", """Save to SD card""")
MVK_SAVE_STATE_ENUM_END = 3
enums["MVK_SAVE_STATE"][3] = EnumEntry("MVK_SAVE_STATE_ENUM_END", """""")

# MVK_SIGNAL_SAT
enums["MVK_SIGNAL_SAT"] = {}
MVK_SAT_FALSE = 0
enums["MVK_SIGNAL_SAT"][0] = EnumEntry("MVK_SAT_FALSE", """False""")
MVK_SAT_TRUE = 1
enums["MVK_SIGNAL_SAT"][1] = EnumEntry("MVK_SAT_TRUE", """True""")
MVK_SIGNAL_SAT_ENUM_END = 2
enums["MVK_SIGNAL_SAT"][2] = EnumEntry("MVK_SIGNAL_SAT_ENUM_END", """""")
...
MVK_DET_X_TRUE = 1
enums["MVK_SIGNAL_MASTER_DET"][1] = EnumEntry("MVK_DET_X_TRUE", """Signal detected in 1 Ant""")
MVK_DET_Y_TRUE = 2
enums["MVK_SIGNAL_MASTER_DET"][2] = EnumEntry("MVK_DET_Y_TRUE", """Signal detected in 1 Ant""")
MVK_DET_Z_TRUE = 3
enums["MVK_SIGNAL_MASTER_DET"][3] = EnumEntry("MVK_DET_Z_TRUE", """Signal detected in 1 Ant""")
MVK_DET_X_AND_Y_TRUE = 4
enums["MVK_SIGNAL_MASTER_DET"][4] = EnumEntry("MVK_DET_X_AND_Y_TRUE", """Signal detected in 2 Ant""")
MVK_DET_X_AND_Z_TRUE = 5
enums["MVK_SIGNAL_MASTER_DET"][5] = EnumEntry("MVK_DET_X_AND_Z_TRUE", """Signal detected in 2 Ant""")
MVK_DET_Y_AND_Z_TRUE = 6
enums["MVK_SIGNAL_MASTER_DET"][6] = EnumEntry("MVK_DET_Y_AND_Z_TRUE", """Signal detected in 2 Ant""")
MVK_DET_X_AND_Y_AND_Z_TRUE = 7
enums["MVK_SIGNAL_MASTER_DET"][7] = EnumEntry("MVK_DET_X_AND_Y_AND_Z_TRUE", """Signal detected in 3 Ant""")
MVK_SIGNAL_MASTER_DET_ENUM_END = 8
enums["MVK_SIGNAL_MASTER_DET"][8] = EnumEntry("MVK_SIGNAL_MASTER_DET_ENUM_END", """""")

# MVK_SIGNAL_DET_SENT
enums["MVK_SIGNAL_DET_SENT"] = {}
MVK_DET_SENT_FALSE = 0
enums["MVK_SIGNAL_DET_SENT"][0] = EnumEntry("MVK_DET_SENT_FALSE", """False""")
MVK_DET_SENT_TRUE = 1
enums["MVK_SIGNAL_DET_SENT"][1] = EnumEntry("MVK_DET_SENT_TRUE", """True""")
MVK_SIGNAL_DET_SENT_ENUM_END = 2
enums["MVK_SIGNAL_DET_SENT"][2] = EnumEntry("MVK_SIGNAL_DET_SENT_ENUM_END", """""")

# MVK_RX_RESET
enums["MVK_RX_RESET"] = {}
MVK_RESET_FALSE = 0
enums["MVK_RX_RESET"][0] = EnumEntry("MVK_RESET_FALSE", """False""")
MVK_RESET_TRUE = 1
enums["MVK_RX_RESET"][1] = EnumEntry("MVK_RESET_TRUE", """True""")
MVK_RX_RESET_ENUM_END = 2
enums["MVK_RX_RESET"][2] = EnumEntry("MVK_RX_RESET_ENUM_END", """""")

# MVK_RX_CHG_REQ
enums["MVK_RX_CHG_REQ"] = {}
MVK_CHG_REQ_FALSE = 0
enums["MVK_RX_CHG_REQ"][0] = EnumEntry("MVK_CHG_REQ_FALSE", """False""")
MVK_CHG_REQ_TRUE = 1
enums["MVK_RX_CHG_REQ"][1] = EnumEntry("MVK_CHG_REQ_TRUE", """True""")
MVK_RX_CHG_REQ_ENUM_END = 2
enums["MVK_RX_CHG_REQ"][2] = EnumEntry("MVK_RX_CHG_REQ_ENUM_END", """""")
...
MAVLINK_MSG_ID_IVAQ_RX_PARAMS_MASTER = 200
MAVLINK_MSG_ID_IVAQ_RX_PARAMS_SLAVE = 201
MAVLINK_MSG_ID_IVAQ_RX_SET_PARAMS_MASTER = 202
MAVLINK_MSG_ID_IVAQ_RX_SET_PARAMS_SLAVE = 203
MAVLINK_MSG_ID_IVAQ_RX_SIGNAL_MASTER = 204
MAVLINK_MSG_ID_IVAQ_RX_SIGNAL_SLAVE = 205
...
class MAVLink_ivaq_rx_params_master_message(MAVLink_message):
    """
    ...
    def __init__(self, rx_mode_x: int, rx_status_x: int, rx_anlg_en_x: int, rx_battery_voltage_x: float, rx_ant_states_x: int, rx_stg_states_x: int, rx_card_det_x: int, rx_save_opt_x: int, rx_mode_y: int, rx_status_y: int, rx_anlg_en_y: int, rx_battery_voltage_y: float, rx_ant_states_y: int, rx_stg_states_y: int, rx_card_det_y: int, rx_save_opt_y: int, rx_mode_z: int, rx_status_z: int, rx_anlg_en_z: int, rx_battery_voltage_z: float, rx_ant_states_z: int, rx_stg_states_z: int, rx_card_det_z: int, rx_save_opt_z: int):
        ...
        self._instance_offset = MAVLink_ivaq_rx_params_master_message.instance_offset
        self.rx_mode_x = rx_mode_x
        self.rx_status_x = rx_status_x
        ...
        self.rx_mode_y = rx_mode_y
        self.rx_status_y = rx_status_y
        ...
        self.rx_mode_z = rx_mode_z
        self.rx_status_z = rx_status_z
...
# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_ivaq_rx_params_master_message, "name", mavlink_msg_deprecated_name_property())


class MAVLink_ivaq_rx_params_slave_message(MAVLink_message):
    """
...
# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_ivaq_rx_params_slave_message, "name", mavlink_msg_deprecated_name_property())


class MAVLink_ivaq_rx_set_params_master_message(MAVLink_message):
    """
    IVAQ Rx Target Parameters for all PCBs (X,Y,X) from Raspi to
    Master
    """

    id = MAVLINK_MSG_ID_IVAQ_RX_SET_PARAMS_MASTER
    msgname = "IVAQ_RX_SET_PARAMS_MASTER"
    fieldnames = ["rx_set_reset_x", "rx_set_anlg_en_x", "rx_set_ant_states_x", "rx_set_stg_states_x", "rx_set_save_opt_x", "rx_set_reset_y", "rx_set_anlg_en_y", "rx_set_ant_states_y", "rx_set_stg_states_y", "rx_set_save_opt_y", "rx_set_reset_z", "rx_set_anlg_en_z", "rx_set_ant_states_z", "rx_set_stg_states_z", "rx_set_save_opt_z"]
    ordered_fieldnames = ["rx_set_reset_x", "rx_set_anlg_en_x", "rx_set_ant_states_x", "rx_set_stg_states_x", "rx_set_save_opt_x", "rx_set_reset_y", "rx_set_anlg_en_y", "rx_set_ant_states_y", "rx_set_stg_states_y", "rx_set_save_opt_y", "rx_set_reset_z", "rx_set_anlg_en_z", "rx_set_ant_states_z", "rx_set_stg_states_z", "rx_set_save_opt_z"]
    fieldtypes = ["uint8_t", "uint8_t", "uint8_t", "uint8_t", "uint8_t", "uint8_t", "uint8_t", "uint8_t", "uint8_t", "uint8_t", "uint8_t", "uint8_t", "uint8_t", "uint8_t", "uint8_t"]
    fielddisplays_by_name: Dict[str, str] = {}
    fieldenums_by_name: Dict[str, str] = {"rx_set_reset_x": "MVK_RX_RESET", "rx_set_anlg_en_x": "MVK_RX_ANLG_EN", "rx_set_ant_states_x": "MVK_ANT_STATES", "rx_set_stg_states_x": "MVK_STAGE_STATES", "rx_set_save_opt_x": "MVK_SAVE_STATE", "rx_set_reset_y": "MVK_RX_RESET", "rx_set_anlg_en_y": "MVK_RX_ANLG_EN", "rx_set_ant_states_y": "MVK_ANT_STATES", "rx_set_stg_states_y": "MVK_STAGE_STATES", "rx_set_save_opt_y": "MVK_SAVE_STATE", "rx_set_reset_z": "MVK_RX_RESET", "rx_set_anlg_en_z": "MVK_RX_ANLG_EN", "rx_set_ant_states_z": "MVK_ANT_STATES", "rx_set_stg_states_z": "MVK_STAGE_STATES", "rx_set_save_opt_z": "MVK_SAVE_STATE"}
    fieldunits_by_name: Dict[str, str] = {}
    native_format = bytearray(b"<BBBBBBBBBBBBBBB")
    ...
    crc_extra = 20
    unpacker = struct.Struct("<BBBBBBBBBBBBBBB")
    instance_field = None
    instance_offset = -1

    def __init__(self, rx_set_reset_x: int, rx_set_anlg_en_x: int, rx_set_ant_states_x: int, rx_set_stg_states_x: int, rx_set_save_opt_x: int, rx_set_reset_y: int, rx_set_anlg_en_y: int, rx_set_ant_states_y: int, rx_set_stg_states_y: int, rx_set_save_opt_y: int, rx_set_reset_z: int, rx_set_anlg_en_z: int, rx_set_ant_states_z: int, rx_set_stg_states_z: int, rx_set_save_opt_z: int):
...
# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_ivaq_rx_set_params_master_message, "name", mavlink_msg_deprecated_name_property())


class MAVLink_ivaq_rx_set_params_slave_message(MAVLink_message):
    """
    ...
    fieldnames = ["rx_time_master_boot_ms", "rx_set_chg_request", "rx_set_reset", "rx_set_anlg_en", "rx_set_ant_states", "rx_set_stg_states", "rx_set_save_opt"]
    ordered_fieldnames = ["rx_time_master_boot_ms", "rx_set_chg_request", "rx_set_reset", "rx_set_anlg_en", "rx_set_ant_states", "rx_set_stg_states", "rx_set_save_opt"]
    fieldtypes = ["uint32_t", "uint8_t", "uint8_t", "uint8_t", "uint8_t", "uint8_t", "uint8_t"]
    fielddisplays_by_name: Dict[str, str] = {}
    fieldenums_by_name: Dict[str, str] = {"rx_set_chg_request": "MVK_RX_CHG_REQ", "rx_set_reset": "MVK_RX_RESET", "rx_set_anlg_en": "MVK_RX_ANLG_EN", "rx_set_ant_states": "MVK_ANT_STATES", "rx_set_stg_states": "MVK_STAGE_STATES", "rx_set_save_opt": "MVK_SAVE_STATE"}
    fieldunits_by_name: Dict[str, str] = {}
    native_format = bytearray(b"<IBBBBBB")
    orders = [0, 1, 2, 3, 4, 5, 6]
    lengths = [1, 1, 1, 1, 1, 1, 1]
    array_lengths = [0, 0, 0, 0, 0, 0, 0]
    crc_extra = 44
    unpacker = struct.Struct("<IBBBBBB")
    instance_field = None
    instance_offset = -1

    def __init__(self, rx_time_master_boot_ms: int, rx_set_chg_request: int, rx_set_reset: int, rx_set_anlg_en: int, rx_set_ant_states: int, rx_set_stg_states: int, rx_set_save_opt: int):
        ...
        self._instance_offset = MAVLink_ivaq_rx_set_params_slave_message.instance_offset
        self.rx_time_master_boot_ms = rx_time_master_boot_ms
    ...
    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(mav, self.crc_extra, self.unpacker.pack(self.rx_time_master_boot_ms, self.rx_set_chg_request, self.rx_set_reset, self.rx_set_anlg_en, self.rx_set_ant_states, self.rx_set_stg_states, self.rx_set_save_opt), force_mavlink1=force_mavlink1)


# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_ivaq_rx_set_params_slave_message, "name", mavlink_msg_deprecated_name_property())


class MAVLink_ivaq_rx_signal_master_message(MAVLink_message):
    """
    Message with Signal from all antennas (X,Y,Z) in IVAQ Rx, uploaded
    to Raspi from Master
    """

    id = MAVLINK_MSG_ID_IVAQ_RX_SIGNAL_MASTER
    msgname = "IVAQ_RX_SIGNAL_MASTER"
    fieldnames = ["rx_signal_det_flag", "rx_signal_det_flag_prev", "rx_signal_det_to_send_flag", "rx_signal_det_time", "rx_signal_det_module", "rx_saturation_flag_x", "rx_signal_det_flag_x", "rx_signal_det_to_send_flag_x", "rx_signal_det_time_x", "rx_signal_det_val_nocorr_x", "rx_signal_det_val_corr_x", "rx_noise_val_nocorr_x", "rx_noise_val_corr_x", "rx_noise_std_nocorr_x", "rx_noise_std_corr_x", "rx_saturation_flag_y", "rx_signal_det_flag_y", "rx_signal_det_to_send_flag_y", "rx_signal_det_time_y", "rx_signal_det_val_nocorr_y", "rx_signal_det_val_corr_y", "rx_noise_val_nocorr_y", "rx_noise_val_corr_y", "rx_noise_std_nocorr_y", "rx_noise_std_corr_y", "rx_saturation_flag_z", "rx_signal_det_flag_z", "rx_signal_det_to_send_flag_z", "rx_signal_det_time_z", "rx_signal_det_val_nocorr_z", "rx_signal_det_val_corr_z", "rx_noise_val_nocorr_z", "rx_noise_val_corr_z", "rx_noise_std_nocorr_z", "rx_noise_std_corr_z"]
    ordered_fieldnames = ["rx_signal_det_time", "rx_signal_det_module", "rx_signal_det_time_x", "rx_signal_det_val_nocorr_x", "rx_signal_det_val_corr_x", "rx_noise_val_nocorr_x", "rx_noise_val_corr_x", "rx_noise_std_nocorr_x", "rx_noise_std_corr_x", "rx_signal_det_time_y", "rx_signal_det_val_nocorr_y", "rx_signal_det_val_corr_y", "rx_noise_val_nocorr_y", "rx_noise_val_corr_y", "rx_noise_std_nocorr_y", "rx_noise_std_corr_y", "rx_signal_det_time_z", "rx_signal_det_val_nocorr_z", "rx_signal_det_val_corr_z", "rx_noise_val_nocorr_z", "rx_noise_val_corr_z", "rx_noise_std_nocorr_z", "rx_noise_std_corr_z", "rx_signal_det_flag", "rx_signal_det_flag_prev", "rx_signal_det_to_send_flag", "rx_saturation_flag_x", "rx_signal_det_flag_x", "rx_signal_det_to_send_flag_x", "rx_saturation_flag_y", "rx_signal_det_flag_y", "rx_signal_det_to_send_flag_y", "rx_saturation_flag_z", "rx_signal_det_flag_z", "rx_signal_det_to_send_flag_z"]
    fieldtypes = ["uint8_t", "uint8_t", "uint8_t", "uint32_t", "float", "uint8_t", "uint8_t", "uint8_t", "uint32_t", "float", "float", "float", "float", "float", "float", "uint8_t", "uint8_t", "uint8_t", "uint32_t", "float", "float", "float", "float", "float", "float", "uint8_t", "uint8_t", "uint8_t", "uint32_t", "float", "float", "float", "float", "float", "float"]
    fielddisplays_by_name: Dict[str, str] = {}
    fieldenums_by_name: Dict[str, str] = {"rx_signal_det_flag": "MVK_SIGNAL_MASTER_DET", "rx_signal_det_flag_prev": "MVK_SIGNAL_MASTER_DET", "rx_signal_det_to_send_flag": "MVK_SIGNAL_DET_SENT", "rx_saturation_flag_x": "MVK_SIGNAL_SAT", "rx_signal_det_flag_x": "MVK_SIGNAL_DET", "rx_signal_det_to_send_flag_x": "MVK_SIGNAL_DET_SENT", "rx_saturation_flag_y": "MVK_SIGNAL_SAT", "rx_signal_det_flag_y": "MVK_SIGNAL_DET", "rx_signal_det_to_send_flag_y": "MVK_SIGNAL_DET_SENT", "rx_saturation_flag_z": "MVK_SIGNAL_SAT", "rx_signal_det_flag_z": "MVK_SIGNAL_DET", "rx_signal_det_to_send_flag_z": "MVK_SIGNAL_DET_SENT"}
    fieldunits_by_name: Dict[str, str] = {}
    native_format = bytearray(b"<IfIffffffIffffffIffffffBBBBBBBBBBBB")
    orders = [23, 24, 25, 0, 1, 26, 27, 28, 2, 3, 4, 5, 6, 7, 8, 29, 30, 31, 9, 10, 11, 12, 13, 14, 15, 32, 33, 34, 16, 17, 18, 19, 20, 21, 22]
    ...
    crc_extra = 154
    unpacker = struct.Struct("<IfIffffffIffffffIffffffBBBBBBBBBBBB")
    instance_field = None
    instance_offset = -1

    def __init__(self, rx_signal_det_flag: int, rx_signal_det_flag_prev: int, rx_signal_det_to_send_flag: int, rx_signal_det_time: int, rx_signal_det_module: float, rx_saturation_flag_x: int, rx_signal_det_flag_x: int, rx_signal_det_to_send_flag_x: int, rx_signal_det_time_x: int, rx_signal_det_val_nocorr_x: float, rx_signal_det_val_corr_x: float, rx_noise_val_nocorr_x: float, rx_noise_val_corr_x: float, rx_noise_std_nocorr_x: float, rx_noise_std_corr_x: float, rx_saturation_flag_y: int, rx_signal_det_flag_y: int, rx_signal_det_to_send_flag_y: int, rx_signal_det_time_y: int, rx_signal_det_val_nocorr_y: float, rx_signal_det_val_corr_y: float, rx_noise_val_nocorr_y: float, rx_noise_val_corr_y: float, rx_noise_std_nocorr_y: float, rx_noise_std_corr_y: float, rx_saturation_flag_z: int, rx_signal_det_flag_z: int, rx_signal_det_to_send_flag_z: int, rx_signal_det_time_z: int, rx_signal_det_val_nocorr_z: float, rx_signal_det_val_corr_z: float, rx_noise_val_nocorr_z: float, rx_noise_val_corr_z: float, rx_noise_std_nocorr_z: float, rx_noise_std_corr_z: float):
        ...
        self.rx_signal_det_flag_prev = rx_signal_det_flag_prev
        ...
        self.rx_signal_det_flag_x = rx_signal_det_flag_x
        self.rx_signal_det_to_send_flag_x = rx_signal_det_to_send_flag_x
        self.rx_signal_det_time_x = rx_signal_det_time_x
        self.rx_signal_det_val_nocorr_x = rx_signal_det_val_nocorr_x
        self.rx_signal_det_val_corr_x = rx_signal_det_val_corr_x
        self.rx_noise_val_nocorr_x = rx_noise_val_nocorr_x
        self.rx_noise_val_corr_x = rx_noise_val_corr_x
        self.rx_noise_std_nocorr_x = rx_noise_std_nocorr_x
        self.rx_noise_std_corr_x = rx_noise_std_corr_x
        self.rx_saturation_flag_y = rx_saturation_flag_y
        self.rx_signal_det_flag_y = rx_signal_det_flag_y
        self.rx_signal_det_to_send_flag_y = rx_signal_det_to_send_flag_y
        self.rx_signal_det_time_y = rx_signal_det_time_y
        self.rx_signal_det_val_nocorr_y = rx_signal_det_val_nocorr_y
        self.rx_signal_det_val_corr_y = rx_signal_det_val_corr_y
        self.rx_noise_val_nocorr_y = rx_noise_val_nocorr_y
        self.rx_noise_val_corr_y = rx_noise_val_corr_y
        self.rx_noise_std_nocorr_y = rx_noise_std_nocorr_y
        self.rx_noise_std_corr_y = rx_noise_std_corr_y
        self.rx_saturation_flag_z = rx_saturation_flag_z
        self.rx_signal_det_flag_z = rx_signal_det_flag_z
        self.rx_signal_det_to_send_flag_z = rx_signal_det_to_send_flag_z
        self.rx_signal_det_time_z = rx_signal_det_time_z
        self.rx_signal_det_val_nocorr_z = rx_signal_det_val_nocorr_z
        self.rx_signal_det_val_corr_z = rx_signal_det_val_corr_z
        self.rx_noise_val_nocorr_z = rx_noise_val_nocorr_z
        self.rx_noise_val_corr_z = rx_noise_val_corr_z
        self.rx_noise_std_nocorr_z = rx_noise_std_nocorr_z
        self.rx_noise_std_corr_z = rx_noise_std_corr_z

    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(mav, self.crc_extra, self.unpacker.pack(self.rx_signal_det_time, self.rx_signal_det_module, self.rx_signal_det_time_x, self.rx_signal_det_val_nocorr_x, self.rx_signal_det_val_corr_x, self.rx_noise_val_nocorr_x, self.rx_noise_val_corr_x, self.rx_noise_std_nocorr_x, self.rx_noise_std_corr_x, self.rx_signal_det_time_y, self.rx_signal_det_val_nocorr_y, self.rx_signal_det_val_corr_y, self.rx_noise_val_nocorr_y, self.rx_noise_val_corr_y, self.rx_noise_std_nocorr_y, self.rx_noise_std_corr_y, self.rx_signal_det_time_z, self.rx_signal_det_val_nocorr_z, self.rx_signal_det_val_corr_z, self.rx_noise_val_nocorr_z, self.rx_noise_val_corr_z, self.rx_noise_std_nocorr_z, self.rx_noise_std_corr_z, self.rx_signal_det_flag, self.rx_signal_det_flag_prev, self.rx_signal_det_to_send_flag, self.rx_saturation_flag_x, self.rx_signal_det_flag_x, self.rx_signal_det_to_send_flag_x, self.rx_saturation_flag_y, self.rx_signal_det_flag_y, self.rx_signal_det_to_send_flag_y, self.rx_saturation_flag_z, self.rx_signal_det_flag_z, self.rx_signal_det_to_send_flag_z), force_mavlink1=force_mavlink1)


# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_ivaq_rx_signal_master_message, "name", mavlink_msg_deprecated_name_property())


class MAVLink_ivaq_rx_signal_slave_message(MAVLink_message):
    """
    Message with Signal from all antennas (X,Y,Z) in IVAQ Rx uploaded
    to Raspi
    """
    ...
    fielddisplays_by_name: Dict[str, str] = {}
    fieldenums_by_name: Dict[str, str] = {"rx_saturation_flag": "MVK_SIGNAL_SAT", "rx_signal_det_flag": "MVK_SIGNAL_DET", "rx_signal_det_to_send_flag": "MVK_SIGNAL_DET_SENT"}
    fieldunits_by_name: Dict[str, str] = {}
    ...
    def __init__(self, rx_saturation_flag: int, rx_signal_det_flag: int, rx_signal_det_to_send_flag: int, rx_signal_det_time: int, rx_signal_det_val_nocorr: float, rx_signal_det_val_corr: float, rx_noise_val_nocorr: float, rx_noise_val_corr: float, rx_noise_std_nocorr: float, rx_noise_std_corr: float):
        ...
        self.rx_noise_val_nocorr = rx_noise_val_nocorr
        self.rx_noise_val_corr = rx_noise_val_corr
        self.rx_noise_std_nocorr = rx_noise_std_nocorr
...
# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_ivaq_rx_signal_slave_message, "name", mavlink_msg_deprecated_name_property())
...
mavlink_map: Dict[int, Type[MAVLink_message]] = {
    ...
    MAVLINK_MSG_ID_IVAQ_RX_PARAMS_MASTER: MAVLink_ivaq_rx_params_master_message,
    MAVLINK_MSG_ID_IVAQ_RX_PARAMS_SLAVE: MAVLink_ivaq_rx_params_slave_message,
    MAVLINK_MSG_ID_IVAQ_RX_SET_PARAMS_MASTER: MAVLink_ivaq_rx_set_params_master_message,
    MAVLINK_MSG_ID_IVAQ_RX_SET_PARAMS_SLAVE: MAVLink_ivaq_rx_set_params_slave_message,
    MAVLINK_MSG_ID_IVAQ_RX_SIGNAL_MASTER: MAVLink_ivaq_rx_signal_master_message,
    MAVLINK_MSG_ID_IVAQ_RX_SIGNAL_SLAVE: MAVLink_ivaq_rx_signal_slave_message,
...
class MAVLink(object):
    ...
    def ivaq_rx_params_master_encode(self, rx_mode_x: int, rx_status_x: int, rx_anlg_en_x: int, rx_battery_voltage_x: float, rx_ant_states_x: int, rx_stg_states_x: int, rx_card_det_x: int, rx_save_opt_x: int, rx_mode_y: int, rx_status_y: int, rx_anlg_en_y: int, rx_battery_voltage_y: float, rx_ant_states_y: int, rx_stg_states_y: int, rx_card_det_y: int, rx_save_opt_y: int, rx_mode_z: int, rx_status_z: int, rx_anlg_en_z: int, rx_battery_voltage_z: float, rx_ant_states_z: int, rx_stg_states_z: int, rx_card_det_z: int, rx_save_opt_z: int) -> MAVLink_ivaq_rx_params_master_message:
        ...
        rx_mode_x                 : Ivaq Rx X-Ant Mode (type:uint8_t, values:MVK_RX_MODE)
        rx_status_x               : Ivaq Rx X-Ant Status (type:uint8_t, values:MVK_RX_STATUS)
        ...
        rx_mode_y                 : Ivaq Rx Y-Ant Mode (type:uint8_t, values:MVK_RX_MODE)
        rx_status_y               : Ivaq Rx Y-Ant Status (type:uint8_t, values:MVK_RX_STATUS)
        ...
        rx_mode_z                 : Ivaq Rx Z-Ant Mode (type:uint8_t, values:MVK_RX_MODE)
        rx_status_z               : Ivaq Rx Z-Ant Status (type:uint8_t, values:MVK_RX_STATUS)
    ...
    def ivaq_rx_set_params_master_encode(self, rx_set_reset_x: int, rx_set_anlg_en_x: int, rx_set_ant_states_x: int, rx_set_stg_states_x: int, rx_set_save_opt_x: int, rx_set_reset_y: int, rx_set_anlg_en_y: int, rx_set_ant_states_y: int, rx_set_stg_states_y: int, rx_set_save_opt_y: int, rx_set_reset_z: int, rx_set_anlg_en_z: int, rx_set_ant_states_z: int, rx_set_stg_states_z: int, rx_set_save_opt_z: int) -> MAVLink_ivaq_rx_set_params_master_message:
        ...
        """
        return MAVLink_ivaq_rx_set_params_master_message(rx_set_reset_x, rx_set_anlg_en_x, rx_set_ant_states_x, rx_set_stg_states_x, rx_set_save_opt_x, rx_set_reset_y, rx_set_anlg_en_y, rx_set_ant_states_y, rx_set_stg_states_y, rx_set_save_opt_y, rx_set_reset_z, rx_set_anlg_en_z, rx_set_ant_states_z, rx_set_stg_states_z, rx_set_save_opt_z)

    def ivaq_rx_set_params_master_send(self, rx_set_reset_x: int, rx_set_anlg_en_x: int, rx_set_ant_states_x: int, rx_set_stg_states_x: int, rx_set_save_opt_x: int, rx_set_reset_y: int, rx_set_anlg_en_y: int, rx_set_ant_states_y: int, rx_set_stg_states_y: int, rx_set_save_opt_y: int, rx_set_reset_z: int, rx_set_anlg_en_z: int, rx_set_ant_states_z: int, rx_set_stg_states_z: int, rx_set_save_opt_z: int, force_mavlink1: bool = False) -> None:
        """
        IVAQ Rx Target Parameters for all PCBs (X,Y,X) from Raspi to Master
        ...
        """
        self.send(self.ivaq_rx_set_params_master_encode(rx_set_reset_x, rx_set_anlg_en_x, rx_set_ant_states_x, rx_set_stg_states_x, rx_set_save_opt_x, rx_set_reset_y, rx_set_anlg_en_y, rx_set_ant_states_y, rx_set_stg_states_y, rx_set_save_opt_y, rx_set_reset_z, rx_set_anlg_en_z, rx_set_ant_states_z, rx_set_stg_states_z, rx_set_save_opt_z), force_mavlink1=force_mavlink1)

    def ivaq_rx_set_params_slave_encode(self, rx_time_master_boot_ms: int, rx_set_chg_request: int, rx_set_reset: int, rx_set_anlg_en: int, rx_set_ant_states: int, rx_set_stg_states: int, rx_set_save_opt: int) -> MAVLink_ivaq_rx_set_params_slave_message:
        """
        IVAQ Rx Target Parameters from Master PCB (X) to Slaves (Y,Z)

        rx_time_master_boot_ms        : IVAQ Rx Master time since boot in ms (type:uint32_t)
        ...
        """
        return MAVLink_ivaq_rx_set_params_slave_message(rx_time_master_boot_ms, rx_set_chg_request, rx_set_reset, rx_set_anlg_en, rx_set_ant_states, rx_set_stg_states, rx_set_save_opt)

    def ivaq_rx_set_params_slave_send(self, rx_time_master_boot_ms: int, rx_set_chg_request: int, rx_set_reset: int, rx_set_anlg_en: int, rx_set_ant_states: int, rx_set_stg_states: int, rx_set_save_opt: int, force_mavlink1: bool = False) -> None:
        """
        IVAQ Rx Target Parameters from Master PCB (X) to Slaves (Y,Z)
        ...
        """
        self.send(self.ivaq_rx_set_params_slave_encode(rx_time_master_boot_ms, rx_set_chg_request, rx_set_reset, rx_set_anlg_en, rx_set_ant_states, rx_set_stg_states, rx_set_save_opt), force_mavlink1=force_mavlink1)

    def ivaq_rx_signal_master_encode(self, rx_signal_det_flag: int, rx_signal_det_flag_prev: int, rx_signal_det_to_send_flag: int, rx_signal_det_time: int, rx_signal_det_module: float, rx_saturation_flag_x: int, rx_signal_det_flag_x: int, rx_signal_det_to_send_flag_x: int, rx_signal_det_time_x: int, rx_signal_det_val_nocorr_x: float, rx_signal_det_val_corr_x: float, rx_noise_val_nocorr_x: float, rx_noise_val_corr_x: float, rx_noise_std_nocorr_x: float, rx_noise_std_corr_x: float, rx_saturation_flag_y: int, rx_signal_det_flag_y: int, rx_signal_det_to_send_flag_y: int, rx_signal_det_time_y: int, rx_signal_det_val_nocorr_y: float, rx_signal_det_val_corr_y: float, rx_noise_val_nocorr_y: float, rx_noise_val_corr_y: float, rx_noise_std_nocorr_y: float, rx_noise_std_corr_y: float, rx_saturation_flag_z: int, rx_signal_det_flag_z: int, rx_signal_det_to_send_flag_z: int, rx_signal_det_time_z: int, rx_signal_det_val_nocorr_z: float, rx_signal_det_val_corr_z: float, rx_noise_val_nocorr_z: float, rx_noise_val_corr_z: float, rx_noise_std_nocorr_z: float, rx_noise_std_corr_z: float) -> MAVLink_ivaq_rx_signal_master_message:
        """
        ...
        rx_signal_det_flag_prev        : Ivaq Rx X-ant Signal Detection flag - Previous (type:uint8_t, values:MVK_SIGNAL_MASTER_DET)
        ...
        rx_signal_det_flag_x        : Ivaq Rx X-ant Signal Detection flag (type:uint8_t, values:MVK_SIGNAL_DET)
        rx_signal_det_to_send_flag_x        : Ivaq Rx X-ant Signal Detected Sent flag (type:uint8_t, values:MVK_SIGNAL_DET_SENT)
        rx_signal_det_time_x        : Ivaq Rx X-ant Signal NoCorr value in detected pulse (type:uint32_t)
        rx_signal_det_val_nocorr_x        : Ivaq Rx X-ant Signal NoCorr value in detected pulse (type:float)
        rx_signal_det_val_corr_x        : Ivaq Rx X-ant Signal Corr value in detected pulse (type:float)
        rx_noise_val_nocorr_x        : Ivaq Rx X-ant Noise No Corr Demod value (type:float)
        rx_noise_val_corr_x        : Ivaq Rx X-ant Noise Corr Demod value (type:float)
        rx_noise_std_nocorr_x        : Ivaq Rx X-ant Noise No Corr Demod std deviation (type:float)
        rx_noise_std_corr_x        : Ivaq Rx X-ant Noise Corr Demod std deviation (type:float)
        rx_saturation_flag_y        : Ivaq Rx Y-ant Saturation flag (type:uint8_t, values:MVK_SIGNAL_SAT)
        rx_signal_det_flag_y        : Ivaq Rx Y-ant Signal Detection flag (type:uint8_t, values:MVK_SIGNAL_DET)
        rx_signal_det_to_send_flag_y        : Ivaq Rx Y-ant Signal Detected Sent flag (type:uint8_t, values:MVK_SIGNAL_DET_SENT)
        rx_signal_det_time_y        : Ivaq Rx Y-ant Signal NoCorr value in detected pulse (type:uint32_t)
        rx_signal_det_val_nocorr_y        : Ivaq Rx Y-ant Signal NoCorr value in detected pulse (type:float)
        rx_signal_det_val_corr_y        : Ivaq Rx Y-ant Signal Corr value in detected pulse (type:float)
        rx_noise_val_nocorr_y        : Ivaq Rx Y-ant Noise No Corr Demod value (type:float)
        rx_noise_val_corr_y        : Ivaq Rx Y-ant Noise Corr Demod value (type:float)
        rx_noise_std_nocorr_y        : Ivaq Rx Y-ant Noise No Corr Demod std deviation (type:float)
        rx_noise_std_corr_y        : Ivaq Rx Y-ant Noise Corr Demod std deviation (type:float)
        rx_saturation_flag_z        : Ivaq Rx Z-ant Saturation flag (type:uint8_t, values:MVK_SIGNAL_SAT)
        rx_signal_det_flag_z        : Ivaq Rx Z-ant Signal Detection flag (type:uint8_t, values:MVK_SIGNAL_DET)
        rx_signal_det_to_send_flag_z        : Ivaq Rx Z-ant Signal Detected Sent flag (type:uint8_t, values:MVK_SIGNAL_DET_SENT)
        rx_signal_det_time_z        : Ivaq Rx Z-ant Signal NoCorr value in detected pulse (type:uint32_t)
        rx_signal_det_val_nocorr_z        : Ivaq Rx Z-ant Signal NoCorr value in detected pulse (type:float)
        rx_signal_det_val_corr_z        : Ivaq Rx Z-ant Signal Corr value in detected pulse (type:float)
        rx_noise_val_nocorr_z        : Ivaq Rx Z-ant Noise No Corr Demod value (type:float)
        rx_noise_val_corr_z        : Ivaq Rx Z-ant Noise Corr Demod value (type:float)
        rx_noise_std_nocorr_z        : Ivaq Rx Z-ant Noise No Corr Demod std deviation (type:float)
        rx_noise_std_corr_z        : Ivaq Rx Z-ant Noise Corr Demod std deviation (type:float)

        """
        return MAVLink_ivaq_rx_signal_master_message(rx_signal_det_flag, rx_signal_det_flag_prev, rx_signal_det_to_send_flag, rx_signal_det_time, rx_signal_det_module, rx_saturation_flag_x, rx_signal_det_flag_x, rx_signal_det_to_send_flag_x, rx_signal_det_time_x, rx_signal_det_val_nocorr_x, rx_signal_det_val_corr_x, rx_noise_val_nocorr_x, rx_noise_val_corr_x, rx_noise_std_nocorr_x, rx_noise_std_corr_x, rx_saturation_flag_y, rx_signal_det_flag_y, rx_signal_det_to_send_flag_y, rx_signal_det_time_y, rx_signal_det_val_nocorr_y, rx_signal_det_val_corr_y, rx_noise_val_nocorr_y, rx_noise_val_corr_y, rx_noise_std_nocorr_y, rx_noise_std_corr_y, rx_saturation_flag_z, rx_signal_det_flag_z, rx_signal_det_to_send_flag_z, rx_signal_det_time_z, rx_signal_det_val_nocorr_z, rx_signal_det_val_corr_z, rx_noise_val_nocorr_z, rx_noise_val_corr_z, rx_noise_std_nocorr_z, rx_noise_std_corr_z)
    ...
    def ivaq_rx_signal_master_send(self, rx_signal_det_flag: int, rx_signal_det_flag_prev: int, rx_signal_det_to_send_flag: int, rx_signal_det_time: int, rx_signal_det_module: float, rx_saturation_flag_x: int, rx_signal_det_flag_x: int, rx_signal_det_to_send_flag_x: int, rx_signal_det_time_x: int, rx_signal_det_val_nocorr_x: float, rx_signal_det_val_corr_x: float, rx_noise_val_nocorr_x: float, rx_noise_val_corr_x: float, rx_noise_std_nocorr_x: float, rx_noise_std_corr_x: float, rx_saturation_flag_y: int, rx_signal_det_flag_y: int, rx_signal_det_to_send_flag_y: int, rx_signal_det_time_y: int, rx_signal_det_val_nocorr_y: float, rx_signal_det_val_corr_y: float, rx_noise_val_nocorr_y: float, rx_noise_val_corr_y: float, rx_noise_std_nocorr_y: float, rx_noise_std_corr_y: float, rx_saturation_flag_z: int, rx_signal_det_flag_z: int, rx_signal_det_to_send_flag_z: int, rx_signal_det_time_z: int, rx_signal_det_val_nocorr_z: float, rx_signal_det_val_corr_z: float, rx_noise_val_nocorr_z: float, rx_noise_val_corr_z: float, rx_noise_std_nocorr_z: float, rx_noise_std_corr_z: float, force_mavlink1: bool = False) -> None:
        ...
        """
        self.send(self.ivaq_rx_signal_master_encode(rx_signal_det_flag, rx_signal_det_flag_prev, rx_signal_det_to_send_flag, rx_signal_det_time, rx_signal_det_module, rx_saturation_flag_x, rx_signal_det_flag_x, rx_signal_det_to_send_flag_x, rx_signal_det_time_x, rx_signal_det_val_nocorr_x, rx_signal_det_val_corr_x, rx_noise_val_nocorr_x, rx_noise_val_corr_x, rx_noise_std_nocorr_x, rx_noise_std_corr_x, rx_saturation_flag_y, rx_signal_det_flag_y, rx_signal_det_to_send_flag_y, rx_signal_det_time_y, rx_signal_det_val_nocorr_y, rx_signal_det_val_corr_y, rx_noise_val_nocorr_y, rx_noise_val_corr_y, rx_noise_std_nocorr_y, rx_noise_std_corr_y, rx_saturation_flag_z, rx_signal_det_flag_z, rx_signal_det_to_send_flag_z, rx_signal_det_time_z, rx_signal_det_val_nocorr_z, rx_signal_det_val_corr_z, rx_noise_val_nocorr_z, rx_noise_val_corr_z, rx_noise_std_nocorr_z, rx_noise_std_corr_z), force_mavlink1=force_mavlink1)
    ...
    def ivaq_rx_signal_slave_encode(self, rx_saturation_flag: int, rx_signal_det_flag: int, rx_signal_det_to_send_flag: int, rx_signal_det_time: int, rx_signal_det_val_nocorr: float, rx_signal_det_val_corr: float, rx_noise_val_nocorr: float, rx_noise_val_corr: float, rx_noise_std_nocorr: float, rx_noise_std_corr: float) -> MAVLink_ivaq_rx_signal_slave_message:
        ...
        rx_signal_det_to_send_flag        : Ivaq Rx Signal Detection flag (type:uint8_t, values:MVK_SIGNAL_DET_SENT)
        ...
        rx_noise_val_nocorr        : Ivaq Rx Noise No Corr Demod value (type:float)
        rx_noise_val_corr         : Ivaq Rx Noise Corr Demod value (type:float)
        rx_noise_std_nocorr        : Ivaq Rx Noise No Corr Demod std deviation (type:float)
