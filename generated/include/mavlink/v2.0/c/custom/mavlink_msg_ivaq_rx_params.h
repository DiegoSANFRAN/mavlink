...
#define MAVLINK_MSG_ID_IVAQ_RX_PARAMS_LEN 4
#define MAVLINK_MSG_ID_IVAQ_RX_PARAMS_MIN_LEN 4
#define MAVLINK_MSG_ID_200_LEN 4
#define MAVLINK_MSG_ID_200_MIN_LEN 4

#define MAVLINK_MSG_ID_IVAQ_RX_PARAMS_CRC 108
#define MAVLINK_MSG_ID_200_CRC 108
...
#define MAVLINK_MESSAGE_INFO_IVAQ_RX_PARAMS { \
    ...
    "IVAQ_RX_PARAMS", \
    4, \
    {  { "rx_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_ivaq_rx_params_t, rx_status) }, \
         { "rx_stg_states", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_ivaq_rx_params_t, rx_stg_states) }, \
         { "rx_save_opt", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_ivaq_rx_params_t, rx_save_opt) }, \
         { "rx_saturation_flag", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_ivaq_rx_params_t, rx_saturation_flag) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_IVAQ_RX_PARAMS { \
...
static inline uint16_t mavlink_msg_ivaq_rx_params_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t rx_status, uint8_t rx_stg_states, uint8_t rx_save_opt, uint8_t rx_saturation_flag)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_IVAQ_RX_PARAMS_LEN];
    _mav_put_uint8_t(buf, 0, rx_status);
    _mav_put_uint8_t(buf, 1, rx_stg_states);
    _mav_put_uint8_t(buf, 2, rx_save_opt);
    _mav_put_uint8_t(buf, 3, rx_saturation_flag);
...
{
    return mavlink_msg_ivaq_rx_params_pack(system_id, component_id, msg, ivaq_rx_params->rx_status, ivaq_rx_params->rx_stg_states, ivaq_rx_params->rx_save_opt, ivaq_rx_params->rx_saturation_flag);
}
...
{
    return mavlink_msg_ivaq_rx_params_pack_chan(system_id, component_id, chan, msg, ivaq_rx_params->rx_status, ivaq_rx_params->rx_stg_states, ivaq_rx_params->rx_save_opt, ivaq_rx_params->rx_saturation_flag);
}
...
{
    return mavlink_msg_ivaq_rx_params_pack_status(system_id, component_id, _status, msg,  ivaq_rx_params->rx_status, ivaq_rx_params->rx_stg_states, ivaq_rx_params->rx_save_opt, ivaq_rx_params->rx_saturation_flag);
}
...
static inline void mavlink_msg_ivaq_rx_params_send(mavlink_channel_t chan, uint8_t rx_status, uint8_t rx_stg_states, uint8_t rx_save_opt, uint8_t rx_saturation_flag)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_IVAQ_RX_PARAMS_LEN];
    _mav_put_uint8_t(buf, 0, rx_status);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_ivaq_rx_params_send(chan, ivaq_rx_params->rx_status, ivaq_rx_params->rx_stg_states, ivaq_rx_params->rx_save_opt, ivaq_rx_params->rx_saturation_flag);
#else
 ...
 */
static inline void mavlink_msg_ivaq_rx_params_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t rx_status, uint8_t rx_stg_states, uint8_t rx_save_opt, uint8_t rx_saturation_flag)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
