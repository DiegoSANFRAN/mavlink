...
#define MAVLINK_MSG_ID_IVAQ_RX_SET_PARAMS_SLAVE_LEN 4
#define MAVLINK_MSG_ID_IVAQ_RX_SET_PARAMS_SLAVE_MIN_LEN 4
...
#define MAVLINK_MESSAGE_INFO_IVAQ_RX_SET_PARAMS_SLAVE { \
    ...
    {  { "rx_set_reset", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_ivaq_rx_set_params_slave_t, rx_set_reset) }, \
         { "rx_set_ant_states", NULL, MAVLINK_TYPE_UINT8_T, 0, 1, offsetof(mavlink_ivaq_rx_set_params_slave_t, rx_set_ant_states) }, \
         { "rx_set_stg_states", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_ivaq_rx_set_params_slave_t, rx_set_stg_states) }, \
         { "rx_set_save_opt", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_ivaq_rx_set_params_slave_t, rx_set_save_opt) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_IVAQ_RX_SET_PARAMS_SLAVE { \
...
static inline uint16_t mavlink_msg_ivaq_rx_set_params_slave_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t rx_set_reset, uint8_t rx_set_ant_states, uint8_t rx_set_stg_states, uint8_t rx_set_save_opt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_IVAQ_RX_SET_PARAMS_SLAVE_LEN];
    _mav_put_uint8_t(buf, 0, rx_set_reset);
    _mav_put_uint8_t(buf, 1, rx_set_ant_states);
    _mav_put_uint8_t(buf, 2, rx_set_stg_states);
    _mav_put_uint8_t(buf, 3, rx_set_save_opt);
...
{
    return mavlink_msg_ivaq_rx_set_params_slave_pack(system_id, component_id, msg, ivaq_rx_set_params_slave->rx_set_reset, ivaq_rx_set_params_slave->rx_set_ant_states, ivaq_rx_set_params_slave->rx_set_stg_states, ivaq_rx_set_params_slave->rx_set_save_opt);
}
...
{
    return mavlink_msg_ivaq_rx_set_params_slave_pack_chan(system_id, component_id, chan, msg, ivaq_rx_set_params_slave->rx_set_reset, ivaq_rx_set_params_slave->rx_set_ant_states, ivaq_rx_set_params_slave->rx_set_stg_states, ivaq_rx_set_params_slave->rx_set_save_opt);
}
...
{
    return mavlink_msg_ivaq_rx_set_params_slave_pack_status(system_id, component_id, _status, msg,  ivaq_rx_set_params_slave->rx_set_reset, ivaq_rx_set_params_slave->rx_set_ant_states, ivaq_rx_set_params_slave->rx_set_stg_states, ivaq_rx_set_params_slave->rx_set_save_opt);
}
...
static inline void mavlink_msg_ivaq_rx_set_params_slave_send(mavlink_channel_t chan, uint8_t rx_set_reset, uint8_t rx_set_ant_states, uint8_t rx_set_stg_states, uint8_t rx_set_save_opt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_IVAQ_RX_SET_PARAMS_SLAVE_LEN];
    _mav_put_uint8_t(buf, 0, rx_set_reset);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_ivaq_rx_set_params_slave_send(chan, ivaq_rx_set_params_slave->rx_set_reset, ivaq_rx_set_params_slave->rx_set_ant_states, ivaq_rx_set_params_slave->rx_set_stg_states, ivaq_rx_set_params_slave->rx_set_save_opt);
#else
 ...
 */
static inline void mavlink_msg_ivaq_rx_set_params_slave_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t rx_set_reset, uint8_t rx_set_ant_states, uint8_t rx_set_stg_states, uint8_t rx_set_save_opt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
