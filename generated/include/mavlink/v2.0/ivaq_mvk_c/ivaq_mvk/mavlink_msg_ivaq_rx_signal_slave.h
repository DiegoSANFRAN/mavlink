...
typedef struct __mavlink_ivaq_rx_signal_slave_t {
 ...
 uint8_t rx_signal_det_sat_flag; /*<  Ivaq Rx Saturation flag for Detected Signal*/
 ...
 * @param rx_signal_det_sat_flag  Ivaq Rx Saturation flag for Detected Signal
                               ...
                               uint8_t rx_saturation_flag, uint8_t rx_signal_det_flag, uint8_t rx_signal_det_sat_flag, uint8_t rx_signal_det_to_send_flag, uint32_t rx_signal_det_time, float rx_signal_det_val_nocorr, float rx_signal_det_val_corr, float rx_noise_val_nocorr, float rx_noise_val_corr, float rx_noise_std_nocorr, float rx_noise_std_corr)
{
    ...
    packet.rx_signal_det_sat_flag = rx_signal_det_sat_flag;
...
{
    return mavlink_msg_ivaq_rx_signal_slave_pack(system_id, component_id, msg, ivaq_rx_signal_slave->rx_saturation_flag, ivaq_rx_signal_slave->rx_signal_det_flag, ivaq_rx_signal_slave->rx_signal_det_sat_flag, ivaq_rx_signal_slave->rx_signal_det_to_send_flag, ivaq_rx_signal_slave->rx_signal_det_time, ivaq_rx_signal_slave->rx_signal_det_val_nocorr, ivaq_rx_signal_slave->rx_signal_det_val_corr, ivaq_rx_signal_slave->rx_noise_val_nocorr, ivaq_rx_signal_slave->rx_noise_val_corr, ivaq_rx_signal_slave->rx_noise_std_nocorr, ivaq_rx_signal_slave->rx_noise_std_corr);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_ivaq_rx_signal_slave_send(chan, ivaq_rx_signal_slave->rx_saturation_flag, ivaq_rx_signal_slave->rx_signal_det_flag, ivaq_rx_signal_slave->rx_signal_det_sat_flag, ivaq_rx_signal_slave->rx_signal_det_to_send_flag, ivaq_rx_signal_slave->rx_signal_det_time, ivaq_rx_signal_slave->rx_signal_det_val_nocorr, ivaq_rx_signal_slave->rx_signal_det_val_corr, ivaq_rx_signal_slave->rx_noise_val_nocorr, ivaq_rx_signal_slave->rx_noise_val_corr, ivaq_rx_signal_slave->rx_noise_std_nocorr, ivaq_rx_signal_slave->rx_noise_std_corr);
#else
...
/**
 * @brief Get field rx_signal_det_sat_flag from ivaq_rx_signal_slave message
 *
 * @return  Ivaq Rx Saturation flag for Detected Signal
 */
...
static inline void mavlink_msg_ivaq_rx_signal_slave_decode(const mavlink_message_t* msg, mavlink_ivaq_rx_signal_slave_t* ivaq_rx_signal_slave)
{
    ...
    ivaq_rx_signal_slave->rx_signal_det_sat_flag = mavlink_msg_ivaq_rx_signal_slave_get_rx_signal_det_sat_flag(msg);
