...
#define MAVLINK_MSG_ID_IVAQ_RX_SIGNAL_SLAVE_LEN 31
#define MAVLINK_MSG_ID_IVAQ_RX_SIGNAL_SLAVE_MIN_LEN 31
#define MAVLINK_MSG_ID_205_LEN 31
#define MAVLINK_MSG_ID_205_MIN_LEN 31

#define MAVLINK_MSG_ID_IVAQ_RX_SIGNAL_SLAVE_CRC 170
#define MAVLINK_MSG_ID_205_CRC 170
...
#define MAVLINK_MESSAGE_INFO_IVAQ_RX_SIGNAL_SLAVE { \
    ...
    {  { "rx_saturation_flag", NULL, MAVLINK_TYPE_UINT8_T, 0, 28, offsetof(mavlink_ivaq_rx_signal_slave_t, rx_saturation_flag) }, \
         ...
         { "rx_signal_det_to_send_flag", NULL, MAVLINK_TYPE_UINT8_T, 0, 30, offsetof(mavlink_ivaq_rx_signal_slave_t, rx_signal_det_to_send_flag) }, \
 ...
 * @param rx_signal_det_to_send_flag  Ivaq Rx Signal Detection flag
...
static inline uint16_t mavlink_msg_ivaq_rx_signal_slave_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t rx_saturation_flag, uint8_t rx_signal_det_flag, uint8_t rx_signal_det_to_send_flag, uint32_t rx_signal_det_time, float rx_signal_det_val_nocorr, float rx_signal_det_val_corr, float rx_noise_val_nocorr, float rx_noise_val_corr, float rx_noise_std_nocorr, float rx_noise_std_corr)
{
    ...
    _mav_put_uint8_t(buf, 30, rx_signal_det_to_send_flag);
...
{
    return mavlink_msg_ivaq_rx_signal_slave_pack(system_id, component_id, msg, ivaq_rx_signal_slave->rx_saturation_flag, ivaq_rx_signal_slave->rx_signal_det_flag, ivaq_rx_signal_slave->rx_signal_det_to_send_flag, ivaq_rx_signal_slave->rx_signal_det_time, ivaq_rx_signal_slave->rx_signal_det_val_nocorr, ivaq_rx_signal_slave->rx_signal_det_val_corr, ivaq_rx_signal_slave->rx_noise_val_nocorr, ivaq_rx_signal_slave->rx_noise_val_corr, ivaq_rx_signal_slave->rx_noise_std_nocorr, ivaq_rx_signal_slave->rx_noise_std_corr);
}
...
static inline void mavlink_msg_ivaq_rx_signal_slave_send(mavlink_channel_t chan, uint8_t rx_saturation_flag, uint8_t rx_signal_det_flag, uint8_t rx_signal_det_to_send_flag, uint32_t rx_signal_det_time, float rx_signal_det_val_nocorr, float rx_signal_det_val_corr, float rx_noise_val_nocorr, float rx_noise_val_corr, float rx_noise_std_nocorr, float rx_noise_std_corr)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_IVAQ_RX_SIGNAL_SLAVE_LEN];
    _mav_put_uint32_t(buf, 0, rx_signal_det_time);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_ivaq_rx_signal_slave_send(chan, ivaq_rx_signal_slave->rx_saturation_flag, ivaq_rx_signal_slave->rx_signal_det_flag, ivaq_rx_signal_slave->rx_signal_det_to_send_flag, ivaq_rx_signal_slave->rx_signal_det_time, ivaq_rx_signal_slave->rx_signal_det_val_nocorr, ivaq_rx_signal_slave->rx_signal_det_val_corr, ivaq_rx_signal_slave->rx_noise_val_nocorr, ivaq_rx_signal_slave->rx_noise_val_corr, ivaq_rx_signal_slave->rx_noise_std_nocorr, ivaq_rx_signal_slave->rx_noise_std_corr);
#else
 ...
 */
static inline void mavlink_msg_ivaq_rx_signal_slave_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t rx_saturation_flag, uint8_t rx_signal_det_flag, uint8_t rx_signal_det_to_send_flag, uint32_t rx_signal_det_time, float rx_signal_det_val_nocorr, float rx_signal_det_val_corr, float rx_noise_val_nocorr, float rx_noise_val_corr, float rx_noise_std_nocorr, float rx_noise_std_corr)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field rx_signal_det_to_send_flag from ivaq_rx_signal_slave message
 *
 * @return  Ivaq Rx Signal Detection flag
 */
...
static inline void mavlink_msg_ivaq_rx_signal_slave_decode(const mavlink_message_t* msg, mavlink_ivaq_rx_signal_slave_t* ivaq_rx_signal_slave)
{
    ...
    ivaq_rx_signal_slave->rx_signal_det_to_send_flag = mavlink_msg_ivaq_rx_signal_slave_get_rx_signal_det_to_send_flag(msg);
#else
