...
typedef struct __mavlink_ivaq_rx_signal_slave_t {
 float rx_signal_raw; /*<  Ivaq Rx Signal Raw Demod value*/
 float rx_signal_corr; /*<  Ivaq Rx Signal Corr Demod value*/
 float rx_noise_raw; /*<  Ivaq Rx Noise Raw Demod value*/
 float rx_noise_corr; /*<  Ivaq Rx Noise Corr Demod value*/
...
#define MAVLINK_MSG_ID_IVAQ_RX_SIGNAL_SLAVE_LEN 18
#define MAVLINK_MSG_ID_IVAQ_RX_SIGNAL_SLAVE_MIN_LEN 18
#define MAVLINK_MSG_ID_205_LEN 18
#define MAVLINK_MSG_ID_205_MIN_LEN 18

#define MAVLINK_MSG_ID_IVAQ_RX_SIGNAL_SLAVE_CRC 11
#define MAVLINK_MSG_ID_205_CRC 11
...
#define MAVLINK_MESSAGE_INFO_IVAQ_RX_SIGNAL_SLAVE { \
    ...
    6, \
    {  { "rx_saturation_flag", NULL, MAVLINK_TYPE_UINT8_T, 0, 16, offsetof(mavlink_ivaq_rx_signal_slave_t, rx_saturation_flag) }, \
         { "rx_signal_det", NULL, MAVLINK_TYPE_UINT8_T, 0, 17, offsetof(mavlink_ivaq_rx_signal_slave_t, rx_signal_det) }, \
         ...
         { "rx_noise_raw", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_ivaq_rx_signal_slave_t, rx_noise_raw) }, \
         { "rx_noise_corr", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_ivaq_rx_signal_slave_t, rx_noise_corr) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_IVAQ_RX_SIGNAL_SLAVE { \
 ...
 * @param rx_signal_raw  Ivaq Rx Signal Raw Demod value
 * @param rx_signal_corr  Ivaq Rx Signal Corr Demod value
 * @param rx_noise_raw  Ivaq Rx Noise Raw Demod value
 * @param rx_noise_corr  Ivaq Rx Noise Corr Demod value
...
static inline uint16_t mavlink_msg_ivaq_rx_signal_slave_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t rx_saturation_flag, uint8_t rx_signal_det, float rx_signal_raw, float rx_signal_corr, float rx_noise_raw, float rx_noise_corr)
{
    ...
    _mav_put_float(buf, 8, rx_noise_raw);
    _mav_put_float(buf, 12, rx_noise_corr);
    _mav_put_uint8_t(buf, 16, rx_saturation_flag);
    _mav_put_uint8_t(buf, 17, rx_signal_det);
    ...
    packet.rx_noise_raw = rx_noise_raw;
    packet.rx_noise_corr = rx_noise_corr;
...
{
    return mavlink_msg_ivaq_rx_signal_slave_pack(system_id, component_id, msg, ivaq_rx_signal_slave->rx_saturation_flag, ivaq_rx_signal_slave->rx_signal_det, ivaq_rx_signal_slave->rx_signal_raw, ivaq_rx_signal_slave->rx_signal_corr, ivaq_rx_signal_slave->rx_noise_raw, ivaq_rx_signal_slave->rx_noise_corr);
}
...
{
    return mavlink_msg_ivaq_rx_signal_slave_pack_chan(system_id, component_id, chan, msg, ivaq_rx_signal_slave->rx_saturation_flag, ivaq_rx_signal_slave->rx_signal_det, ivaq_rx_signal_slave->rx_signal_raw, ivaq_rx_signal_slave->rx_signal_corr, ivaq_rx_signal_slave->rx_noise_raw, ivaq_rx_signal_slave->rx_noise_corr);
}
...
{
    return mavlink_msg_ivaq_rx_signal_slave_pack_status(system_id, component_id, _status, msg,  ivaq_rx_signal_slave->rx_saturation_flag, ivaq_rx_signal_slave->rx_signal_det, ivaq_rx_signal_slave->rx_signal_raw, ivaq_rx_signal_slave->rx_signal_corr, ivaq_rx_signal_slave->rx_noise_raw, ivaq_rx_signal_slave->rx_noise_corr);
}
...
static inline void mavlink_msg_ivaq_rx_signal_slave_send(mavlink_channel_t chan, uint8_t rx_saturation_flag, uint8_t rx_signal_det, float rx_signal_raw, float rx_signal_corr, float rx_noise_raw, float rx_noise_corr)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_IVAQ_RX_SIGNAL_SLAVE_LEN];
    _mav_put_float(buf, 0, rx_signal_raw);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_ivaq_rx_signal_slave_send(chan, ivaq_rx_signal_slave->rx_saturation_flag, ivaq_rx_signal_slave->rx_signal_det, ivaq_rx_signal_slave->rx_signal_raw, ivaq_rx_signal_slave->rx_signal_corr, ivaq_rx_signal_slave->rx_noise_raw, ivaq_rx_signal_slave->rx_noise_corr);
#else
 ...
 */
static inline void mavlink_msg_ivaq_rx_signal_slave_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t rx_saturation_flag, uint8_t rx_signal_det, float rx_signal_raw, float rx_signal_corr, float rx_noise_raw, float rx_noise_corr)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 *
 * @return  Ivaq Rx Signal Raw Demod value
 */
 ...
 *
 * @return  Ivaq Rx Signal Corr Demod value
 */
...
/**
 * @brief Get field rx_noise_raw from ivaq_rx_signal_slave message
 *
 * @return  Ivaq Rx Noise Raw Demod value
 */
static inline float mavlink_msg_ivaq_rx_signal_slave_get_rx_noise_raw(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float(msg,  8);
}

/**
 * @brief Get field rx_noise_corr from ivaq_rx_signal_slave message
 *
 * @return  Ivaq Rx Noise Corr Demod value
 */
static inline float mavlink_msg_ivaq_rx_signal_slave_get_rx_noise_corr(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_ivaq_rx_signal_slave_decode(const mavlink_message_t* msg, mavlink_ivaq_rx_signal_slave_t* ivaq_rx_signal_slave)
{
    ...
    ivaq_rx_signal_slave->rx_noise_raw = mavlink_msg_ivaq_rx_signal_slave_get_rx_noise_raw(msg);
    ivaq_rx_signal_slave->rx_noise_corr = mavlink_msg_ivaq_rx_signal_slave_get_rx_noise_corr(msg);
