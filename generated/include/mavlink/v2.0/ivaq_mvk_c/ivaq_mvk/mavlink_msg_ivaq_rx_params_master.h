...
typedef struct __mavlink_ivaq_rx_params_master_t {
 ...
 uint8_t rx_stgs_operation_x; /*<  Ivaq Rx X-Ant Stages Operation (automatic/manual)*/
 ...
 uint8_t rx_stgs_operation_y; /*<  Ivaq Rx Y-Ant Stages Operation (automatic/manual)*/
 ...
 uint8_t rx_stgs_operation_z; /*<  Ivaq Rx Z-Ant Stages Operation (automatic/manual)*/
...
#define MAVLINK_MSG_ID_IVAQ_RX_PARAMS_MASTER_LEN 36
#define MAVLINK_MSG_ID_IVAQ_RX_PARAMS_MASTER_MIN_LEN 36
#define MAVLINK_MSG_ID_200_LEN 36
#define MAVLINK_MSG_ID_200_MIN_LEN 36

#define MAVLINK_MSG_ID_IVAQ_RX_PARAMS_MASTER_CRC 176
#define MAVLINK_MSG_ID_200_CRC 176
...
#define MAVLINK_MESSAGE_INFO_IVAQ_RX_PARAMS_MASTER { \
    ...
    {  { "rx_mode_x", NULL, MAVLINK_TYPE_UINT8_T, 0, 12, offsetof(mavlink_ivaq_rx_params_master_t, rx_mode_x) }, \
         ...
         { "rx_stgs_operation_x", NULL, MAVLINK_TYPE_UINT8_T, 0, 16, offsetof(mavlink_ivaq_rx_params_master_t, rx_stgs_operation_x) }, \
         { "rx_stg_states_x", NULL, MAVLINK_TYPE_UINT8_T, 0, 17, offsetof(mavlink_ivaq_rx_params_master_t, rx_stg_states_x) }, \
         { "rx_card_det_x", NULL, MAVLINK_TYPE_UINT8_T, 0, 18, offsetof(mavlink_ivaq_rx_params_master_t, rx_card_det_x) }, \
         { "rx_save_opt_x", NULL, MAVLINK_TYPE_UINT8_T, 0, 19, offsetof(mavlink_ivaq_rx_params_master_t, rx_save_opt_x) }, \
         { "rx_mode_y", NULL, MAVLINK_TYPE_UINT8_T, 0, 20, offsetof(mavlink_ivaq_rx_params_master_t, rx_mode_y) }, \
         { "rx_status_y", NULL, MAVLINK_TYPE_UINT8_T, 0, 21, offsetof(mavlink_ivaq_rx_params_master_t, rx_status_y) }, \
         { "rx_anlg_en_y", NULL, MAVLINK_TYPE_UINT8_T, 0, 22, offsetof(mavlink_ivaq_rx_params_master_t, rx_anlg_en_y) }, \
         { "rx_battery_voltage_y", NULL, MAVLINK_TYPE_FLOAT, 0, 4, offsetof(mavlink_ivaq_rx_params_master_t, rx_battery_voltage_y) }, \
         { "rx_ant_states_y", NULL, MAVLINK_TYPE_UINT8_T, 0, 23, offsetof(mavlink_ivaq_rx_params_master_t, rx_ant_states_y) }, \
         { "rx_stgs_operation_y", NULL, MAVLINK_TYPE_UINT8_T, 0, 24, offsetof(mavlink_ivaq_rx_params_master_t, rx_stgs_operation_y) }, \
         { "rx_stg_states_y", NULL, MAVLINK_TYPE_UINT8_T, 0, 25, offsetof(mavlink_ivaq_rx_params_master_t, rx_stg_states_y) }, \
         { "rx_card_det_y", NULL, MAVLINK_TYPE_UINT8_T, 0, 26, offsetof(mavlink_ivaq_rx_params_master_t, rx_card_det_y) }, \
         { "rx_save_opt_y", NULL, MAVLINK_TYPE_UINT8_T, 0, 27, offsetof(mavlink_ivaq_rx_params_master_t, rx_save_opt_y) }, \
         { "rx_mode_z", NULL, MAVLINK_TYPE_UINT8_T, 0, 28, offsetof(mavlink_ivaq_rx_params_master_t, rx_mode_z) }, \
         { "rx_status_z", NULL, MAVLINK_TYPE_UINT8_T, 0, 29, offsetof(mavlink_ivaq_rx_params_master_t, rx_status_z) }, \
         { "rx_anlg_en_z", NULL, MAVLINK_TYPE_UINT8_T, 0, 30, offsetof(mavlink_ivaq_rx_params_master_t, rx_anlg_en_z) }, \
         { "rx_battery_voltage_z", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_ivaq_rx_params_master_t, rx_battery_voltage_z) }, \
         { "rx_ant_states_z", NULL, MAVLINK_TYPE_UINT8_T, 0, 31, offsetof(mavlink_ivaq_rx_params_master_t, rx_ant_states_z) }, \
         { "rx_stgs_operation_z", NULL, MAVLINK_TYPE_UINT8_T, 0, 32, offsetof(mavlink_ivaq_rx_params_master_t, rx_stgs_operation_z) }, \
         { "rx_stg_states_z", NULL, MAVLINK_TYPE_UINT8_T, 0, 33, offsetof(mavlink_ivaq_rx_params_master_t, rx_stg_states_z) }, \
         { "rx_card_det_z", NULL, MAVLINK_TYPE_UINT8_T, 0, 34, offsetof(mavlink_ivaq_rx_params_master_t, rx_card_det_z) }, \
         { "rx_save_opt_z", NULL, MAVLINK_TYPE_UINT8_T, 0, 35, offsetof(mavlink_ivaq_rx_params_master_t, rx_save_opt_z) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_IVAQ_RX_PARAMS_MASTER { \
 ...
 * @param rx_stgs_operation_x  Ivaq Rx X-Ant Stages Operation (automatic/manual)
 ...
 * @param rx_stgs_operation_y  Ivaq Rx Y-Ant Stages Operation (automatic/manual)
 ...
 * @param rx_stgs_operation_z  Ivaq Rx Z-Ant Stages Operation (automatic/manual)
...
static inline uint16_t mavlink_msg_ivaq_rx_params_master_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t rx_mode_x, uint8_t rx_status_x, uint8_t rx_anlg_en_x, float rx_battery_voltage_x, uint8_t rx_ant_states_x, uint8_t rx_stgs_operation_x, uint8_t rx_stg_states_x, uint8_t rx_card_det_x, uint8_t rx_save_opt_x, uint8_t rx_mode_y, uint8_t rx_status_y, uint8_t rx_anlg_en_y, float rx_battery_voltage_y, uint8_t rx_ant_states_y, uint8_t rx_stgs_operation_y, uint8_t rx_stg_states_y, uint8_t rx_card_det_y, uint8_t rx_save_opt_y, uint8_t rx_mode_z, uint8_t rx_status_z, uint8_t rx_anlg_en_z, float rx_battery_voltage_z, uint8_t rx_ant_states_z, uint8_t rx_stgs_operation_z, uint8_t rx_stg_states_z, uint8_t rx_card_det_z, uint8_t rx_save_opt_z)
{
    ...
    _mav_put_uint8_t(buf, 16, rx_stgs_operation_x);
    _mav_put_uint8_t(buf, 17, rx_stg_states_x);
    _mav_put_uint8_t(buf, 18, rx_card_det_x);
    _mav_put_uint8_t(buf, 19, rx_save_opt_x);
    _mav_put_uint8_t(buf, 20, rx_mode_y);
    _mav_put_uint8_t(buf, 21, rx_status_y);
    _mav_put_uint8_t(buf, 22, rx_anlg_en_y);
    _mav_put_uint8_t(buf, 23, rx_ant_states_y);
    _mav_put_uint8_t(buf, 24, rx_stgs_operation_y);
    _mav_put_uint8_t(buf, 25, rx_stg_states_y);
    _mav_put_uint8_t(buf, 26, rx_card_det_y);
    _mav_put_uint8_t(buf, 27, rx_save_opt_y);
    _mav_put_uint8_t(buf, 28, rx_mode_z);
    _mav_put_uint8_t(buf, 29, rx_status_z);
    _mav_put_uint8_t(buf, 30, rx_anlg_en_z);
    _mav_put_uint8_t(buf, 31, rx_ant_states_z);
    _mav_put_uint8_t(buf, 32, rx_stgs_operation_z);
    _mav_put_uint8_t(buf, 33, rx_stg_states_z);
    _mav_put_uint8_t(buf, 34, rx_card_det_z);
    _mav_put_uint8_t(buf, 35, rx_save_opt_z);
    ...
    packet.rx_stgs_operation_x = rx_stgs_operation_x;
    ...
    packet.rx_stgs_operation_y = rx_stgs_operation_y;
    ...
    packet.rx_stgs_operation_z = rx_stgs_operation_z;
...
/**
 * @brief Get field rx_stgs_operation_x from ivaq_rx_params_master message
 *
 * @return  Ivaq Rx X-Ant Stages Operation (automatic/manual)
 */
static inline uint8_t mavlink_msg_ivaq_rx_params_master_get_rx_stgs_operation_x(const mavlink_message_t* msg)
{
...
/**
 * @brief Get field rx_stgs_operation_y from ivaq_rx_params_master message
 *
 * @return  Ivaq Rx Y-Ant Stages Operation (automatic/manual)
 */
static inline uint8_t mavlink_msg_ivaq_rx_params_master_get_rx_stgs_operation_y(const mavlink_message_t* msg)
{
...
/**
 * @brief Get field rx_stgs_operation_z from ivaq_rx_params_master message
 *
 * @return  Ivaq Rx Z-Ant Stages Operation (automatic/manual)
 */
static inline uint8_t mavlink_msg_ivaq_rx_params_master_get_rx_stgs_operation_z(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_ivaq_rx_params_master_decode(const mavlink_message_t* msg, mavlink_ivaq_rx_params_master_t* ivaq_rx_params_master)
{
    ...
    ivaq_rx_params_master->rx_stgs_operation_x = mavlink_msg_ivaq_rx_params_master_get_rx_stgs_operation_x(msg);
    ...
    ivaq_rx_params_master->rx_stgs_operation_y = mavlink_msg_ivaq_rx_params_master_get_rx_stgs_operation_y(msg);
    ...
    ivaq_rx_params_master->rx_stgs_operation_z = mavlink_msg_ivaq_rx_params_master_get_rx_stgs_operation_z(msg);
