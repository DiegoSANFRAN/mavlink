/** @file
 *    @brief MAVLink comm protocol testsuite generated from ivaq_mvk_c.xml
 *    @see https://mavlink.io/en/
 */
#pragma once
#ifndef IVAQ_MVK_C_TESTSUITE_H
#define IVAQ_MVK_C_TESTSUITE_H
...
static void mavlink_test_ivaq_mvk_c(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    mavlink_test_minimal(system_id, component_id, last_msg);
    mavlink_test_ivaq_mvk_c(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_ivaq_rx_set_params_master(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_ivaq_rx_set_params_master_t packet_in = {
        5,72,139,206,17,84,151,218,29,96,163,230,41,108,175,242,53,120,187,254,65
    };
    mavlink_ivaq_rx_set_params_master_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.rx_set_update_x = packet_in.rx_set_update_x;
        ...
        packet1.rx_set_update_y = packet_in.rx_set_update_y;
        ...
        packet1.rx_set_update_z = packet_in.rx_set_update_z;
    ...
    mavlink_msg_ivaq_rx_set_params_master_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ivaq_rx_set_params_master_pack(system_id, component_id, &msg , packet1.rx_set_update_x , packet1.rx_set_reset_x , packet1.rx_set_anlg_en_x , packet1.rx_set_ant_states_x , packet1.rx_set_stgs_operation_x , packet1.rx_set_stg_states_x , packet1.rx_set_save_opt_x , packet1.rx_set_update_y , packet1.rx_set_reset_y , packet1.rx_set_anlg_en_y , packet1.rx_set_ant_states_y , packet1.rx_set_stgs_operation_y , packet1.rx_set_stg_states_y , packet1.rx_set_save_opt_y , packet1.rx_set_update_z , packet1.rx_set_reset_z , packet1.rx_set_anlg_en_z , packet1.rx_set_ant_states_z , packet1.rx_set_stgs_operation_z , packet1.rx_set_stg_states_z , packet1.rx_set_save_opt_z );
    mavlink_msg_ivaq_rx_set_params_master_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ivaq_rx_set_params_master_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.rx_set_update_x , packet1.rx_set_reset_x , packet1.rx_set_anlg_en_x , packet1.rx_set_ant_states_x , packet1.rx_set_stgs_operation_x , packet1.rx_set_stg_states_x , packet1.rx_set_save_opt_x , packet1.rx_set_update_y , packet1.rx_set_reset_y , packet1.rx_set_anlg_en_y , packet1.rx_set_ant_states_y , packet1.rx_set_stgs_operation_y , packet1.rx_set_stg_states_y , packet1.rx_set_save_opt_y , packet1.rx_set_update_z , packet1.rx_set_reset_z , packet1.rx_set_anlg_en_z , packet1.rx_set_ant_states_z , packet1.rx_set_stgs_operation_z , packet1.rx_set_stg_states_z , packet1.rx_set_save_opt_z );
    mavlink_msg_ivaq_rx_set_params_master_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_ivaq_rx_set_params_master_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ivaq_rx_set_params_master_send(MAVLINK_COMM_1 , packet1.rx_set_update_x , packet1.rx_set_reset_x , packet1.rx_set_anlg_en_x , packet1.rx_set_ant_states_x , packet1.rx_set_stgs_operation_x , packet1.rx_set_stg_states_x , packet1.rx_set_save_opt_x , packet1.rx_set_update_y , packet1.rx_set_reset_y , packet1.rx_set_anlg_en_y , packet1.rx_set_ant_states_y , packet1.rx_set_stgs_operation_y , packet1.rx_set_stg_states_y , packet1.rx_set_save_opt_y , packet1.rx_set_update_z , packet1.rx_set_reset_z , packet1.rx_set_anlg_en_z , packet1.rx_set_ant_states_z , packet1.rx_set_stgs_operation_z , packet1.rx_set_stg_states_z , packet1.rx_set_save_opt_z );
    mavlink_msg_ivaq_rx_set_params_master_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_ivaq_rx_set_params_slave(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_ivaq_rx_set_params_slave_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.rx_time_px_unix_ms = packet_in.rx_time_px_unix_ms;
    ...
    mavlink_msg_ivaq_rx_set_params_slave_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ivaq_rx_set_params_slave_pack(system_id, component_id, &msg , packet1.rx_time_px_unix_ms , packet1.rx_set_chg_request , packet1.rx_set_update , packet1.rx_set_reset , packet1.rx_set_anlg_en , packet1.rx_set_ant_states , packet1.rx_set_stgs_operation , packet1.rx_set_stg_states , packet1.rx_set_save_opt );
    mavlink_msg_ivaq_rx_set_params_slave_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ivaq_rx_set_params_slave_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.rx_time_px_unix_ms , packet1.rx_set_chg_request , packet1.rx_set_update , packet1.rx_set_reset , packet1.rx_set_anlg_en , packet1.rx_set_ant_states , packet1.rx_set_stgs_operation , packet1.rx_set_stg_states , packet1.rx_set_save_opt );
    mavlink_msg_ivaq_rx_set_params_slave_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_ivaq_rx_set_params_slave_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ivaq_rx_set_params_slave_send(MAVLINK_COMM_1 , packet1.rx_time_px_unix_ms , packet1.rx_set_chg_request , packet1.rx_set_update , packet1.rx_set_reset , packet1.rx_set_anlg_en , packet1.rx_set_ant_states , packet1.rx_set_stgs_operation , packet1.rx_set_stg_states , packet1.rx_set_save_opt );
    mavlink_msg_ivaq_rx_set_params_slave_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_ivaq_rx_signal_master(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_ivaq_rx_signal_master_t packet_in = {
        93372036854775807ULL,93372036854776311ULL,93372036854776815ULL,93372036854777319ULL,241.0,269.0,297.0,325.0,353.0,381.0,409.0,437.0,465.0,493.0,521.0,549.0,577.0,605.0,633.0,661.0,689.0,717.0,745.0,773.0,85,152,219,30,97,164,231,42,109,176,243
    };
    mavlink_ivaq_rx_signal_master_t packet1, packet2;
        ...
        packet1.rx_signal_det_time_z = packet_in.rx_signal_det_time_z;
        ...
        packet1.rx_signal_det_val_nocorr_z = packet_in.rx_signal_det_val_nocorr_z;
        packet1.rx_signal_det_val_corr_z = packet_in.rx_signal_det_val_corr_z;
        packet1.rx_noise_val_nocorr_z = packet_in.rx_noise_val_nocorr_z;
        packet1.rx_noise_val_corr_z = packet_in.rx_noise_val_corr_z;
        packet1.rx_noise_std_nocorr_z = packet_in.rx_noise_std_nocorr_z;
        packet1.rx_noise_std_corr_z = packet_in.rx_noise_std_corr_z;
        packet1.rx_signal_det_flag = packet_in.rx_signal_det_flag;
        packet1.rx_signal_det_to_send_flag = packet_in.rx_signal_det_to_send_flag;
        ...
        packet1.rx_signal_det_flag_z = packet_in.rx_signal_det_flag_z;
        packet1.rx_signal_det_sat_flag_z = packet_in.rx_signal_det_sat_flag_z;
    ...
    mavlink_msg_ivaq_rx_signal_master_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ivaq_rx_signal_master_pack(system_id, component_id, &msg , packet1.rx_signal_det_flag , packet1.rx_signal_det_to_send_flag , packet1.rx_signal_det_time , packet1.rx_signal_det_module_nocorr , packet1.rx_signal_det_module_corr , packet1.rx_saturation_flag_x , packet1.rx_signal_det_flag_x , packet1.rx_signal_det_sat_flag_x , packet1.rx_signal_det_time_x , packet1.rx_signal_det_val_nocorr_x , packet1.rx_signal_det_val_corr_x , packet1.rx_noise_val_nocorr_x , packet1.rx_noise_val_corr_x , packet1.rx_noise_std_nocorr_x , packet1.rx_noise_std_corr_x , packet1.rx_saturation_flag_y , packet1.rx_signal_det_flag_y , packet1.rx_signal_det_sat_flag_y , packet1.rx_signal_det_time_y , packet1.rx_signal_det_val_nocorr_y , packet1.rx_signal_det_val_corr_y , packet1.rx_noise_val_nocorr_y , packet1.rx_noise_val_corr_y , packet1.rx_noise_std_nocorr_y , packet1.rx_noise_std_corr_y , packet1.rx_saturation_flag_z , packet1.rx_signal_det_flag_z , packet1.rx_signal_det_sat_flag_z , packet1.rx_signal_det_time_z , packet1.rx_signal_det_val_nocorr_z , packet1.rx_signal_det_val_corr_z , packet1.rx_noise_val_nocorr_z , packet1.rx_noise_val_corr_z , packet1.rx_noise_std_nocorr_z , packet1.rx_noise_std_corr_z );
    mavlink_msg_ivaq_rx_signal_master_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ivaq_rx_signal_master_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.rx_signal_det_flag , packet1.rx_signal_det_to_send_flag , packet1.rx_signal_det_time , packet1.rx_signal_det_module_nocorr , packet1.rx_signal_det_module_corr , packet1.rx_saturation_flag_x , packet1.rx_signal_det_flag_x , packet1.rx_signal_det_sat_flag_x , packet1.rx_signal_det_time_x , packet1.rx_signal_det_val_nocorr_x , packet1.rx_signal_det_val_corr_x , packet1.rx_noise_val_nocorr_x , packet1.rx_noise_val_corr_x , packet1.rx_noise_std_nocorr_x , packet1.rx_noise_std_corr_x , packet1.rx_saturation_flag_y , packet1.rx_signal_det_flag_y , packet1.rx_signal_det_sat_flag_y , packet1.rx_signal_det_time_y , packet1.rx_signal_det_val_nocorr_y , packet1.rx_signal_det_val_corr_y , packet1.rx_noise_val_nocorr_y , packet1.rx_noise_val_corr_y , packet1.rx_noise_std_nocorr_y , packet1.rx_noise_std_corr_y , packet1.rx_saturation_flag_z , packet1.rx_signal_det_flag_z , packet1.rx_signal_det_sat_flag_z , packet1.rx_signal_det_time_z , packet1.rx_signal_det_val_nocorr_z , packet1.rx_signal_det_val_corr_z , packet1.rx_noise_val_nocorr_z , packet1.rx_noise_val_corr_z , packet1.rx_noise_std_nocorr_z , packet1.rx_noise_std_corr_z );
    mavlink_msg_ivaq_rx_signal_master_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_ivaq_rx_signal_master_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ivaq_rx_signal_master_send(MAVLINK_COMM_1 , packet1.rx_signal_det_flag , packet1.rx_signal_det_to_send_flag , packet1.rx_signal_det_time , packet1.rx_signal_det_module_nocorr , packet1.rx_signal_det_module_corr , packet1.rx_saturation_flag_x , packet1.rx_signal_det_flag_x , packet1.rx_signal_det_sat_flag_x , packet1.rx_signal_det_time_x , packet1.rx_signal_det_val_nocorr_x , packet1.rx_signal_det_val_corr_x , packet1.rx_noise_val_nocorr_x , packet1.rx_noise_val_corr_x , packet1.rx_noise_std_nocorr_x , packet1.rx_noise_std_corr_x , packet1.rx_saturation_flag_y , packet1.rx_signal_det_flag_y , packet1.rx_signal_det_sat_flag_y , packet1.rx_signal_det_time_y , packet1.rx_signal_det_val_nocorr_y , packet1.rx_signal_det_val_corr_y , packet1.rx_noise_val_nocorr_y , packet1.rx_noise_val_corr_y , packet1.rx_noise_std_nocorr_y , packet1.rx_noise_std_corr_y , packet1.rx_saturation_flag_z , packet1.rx_signal_det_flag_z , packet1.rx_signal_det_sat_flag_z , packet1.rx_signal_det_time_z , packet1.rx_signal_det_val_nocorr_z , packet1.rx_signal_det_val_corr_z , packet1.rx_noise_val_nocorr_z , packet1.rx_noise_val_corr_z , packet1.rx_noise_std_nocorr_z , packet1.rx_noise_std_corr_z );
    mavlink_msg_ivaq_rx_signal_master_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_ivaq_rx_signal_slave(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_ivaq_rx_signal_slave_t packet_in = {
        93372036854775807ULL,73.0,101.0,129.0,157.0,185.0,213.0,101,168,235,46
    };
    mavlink_ivaq_rx_signal_slave_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.rx_signal_det_time = packet_in.rx_signal_det_time;
        packet1.rx_signal_det_val_nocorr = packet_in.rx_signal_det_val_nocorr;
        packet1.rx_signal_det_val_corr = packet_in.rx_signal_det_val_corr;
        packet1.rx_noise_val_nocorr = packet_in.rx_noise_val_nocorr;
        packet1.rx_noise_val_corr = packet_in.rx_noise_val_corr;
        packet1.rx_noise_std_nocorr = packet_in.rx_noise_std_nocorr;
        packet1.rx_noise_std_corr = packet_in.rx_noise_std_corr;
        packet1.rx_saturation_flag = packet_in.rx_saturation_flag;
        packet1.rx_signal_det_flag = packet_in.rx_signal_det_flag;
        packet1.rx_signal_det_sat_flag = packet_in.rx_signal_det_sat_flag;
        packet1.rx_signal_det_to_send_flag = packet_in.rx_signal_det_to_send_flag;
    ...
    mavlink_msg_ivaq_rx_signal_slave_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ivaq_rx_signal_slave_pack(system_id, component_id, &msg , packet1.rx_saturation_flag , packet1.rx_signal_det_flag , packet1.rx_signal_det_sat_flag , packet1.rx_signal_det_to_send_flag , packet1.rx_signal_det_time , packet1.rx_signal_det_val_nocorr , packet1.rx_signal_det_val_corr , packet1.rx_noise_val_nocorr , packet1.rx_noise_val_corr , packet1.rx_noise_std_nocorr , packet1.rx_noise_std_corr );
    mavlink_msg_ivaq_rx_signal_slave_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ivaq_rx_signal_slave_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.rx_saturation_flag , packet1.rx_signal_det_flag , packet1.rx_signal_det_sat_flag , packet1.rx_signal_det_to_send_flag , packet1.rx_signal_det_time , packet1.rx_signal_det_val_nocorr , packet1.rx_signal_det_val_corr , packet1.rx_noise_val_nocorr , packet1.rx_noise_val_corr , packet1.rx_noise_std_nocorr , packet1.rx_noise_std_corr );
    mavlink_msg_ivaq_rx_signal_slave_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_ivaq_rx_signal_slave_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ivaq_rx_signal_slave_send(MAVLINK_COMM_1 , packet1.rx_saturation_flag , packet1.rx_signal_det_flag , packet1.rx_signal_det_sat_flag , packet1.rx_signal_det_to_send_flag , packet1.rx_signal_det_time , packet1.rx_signal_det_val_nocorr , packet1.rx_signal_det_val_corr , packet1.rx_noise_val_nocorr , packet1.rx_noise_val_corr , packet1.rx_noise_std_nocorr , packet1.rx_noise_std_corr );
    mavlink_msg_ivaq_rx_signal_slave_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_ivaq_mvk_c(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
