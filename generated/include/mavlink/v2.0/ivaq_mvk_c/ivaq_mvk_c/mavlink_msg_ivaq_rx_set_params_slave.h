...
typedef struct __mavlink_ivaq_rx_set_params_slave_t {
 uint64_t rx_time_px_unix_ms; /*<  IVAQ Rx Master time since boot in ms*/
 uint8_t rx_set_chg_request; /*<  Ivaq Rx Set Change Request*/
 uint8_t rx_set_update; /*<  Ivaq Rx Set Update Firmware*/
 ...
 uint8_t rx_set_stgs_operation; /*<  Ivaq Rx Set Stages Operation (automatic/manual)*/
...
#define MAVLINK_MSG_ID_IVAQ_RX_SET_PARAMS_SLAVE_LEN 16
#define MAVLINK_MSG_ID_IVAQ_RX_SET_PARAMS_SLAVE_MIN_LEN 16
#define MAVLINK_MSG_ID_203_LEN 16
#define MAVLINK_MSG_ID_203_MIN_LEN 16

#define MAVLINK_MSG_ID_IVAQ_RX_SET_PARAMS_SLAVE_CRC 170
#define MAVLINK_MSG_ID_203_CRC 170
...
#define MAVLINK_MESSAGE_INFO_IVAQ_RX_SET_PARAMS_SLAVE { \
    ...
    9, \
    {  { "rx_time_px_unix_ms", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_ivaq_rx_set_params_slave_t, rx_time_px_unix_ms) }, \
         { "rx_set_chg_request", NULL, MAVLINK_TYPE_UINT8_T, 0, 8, offsetof(mavlink_ivaq_rx_set_params_slave_t, rx_set_chg_request) }, \
         { "rx_set_update", NULL, MAVLINK_TYPE_UINT8_T, 0, 9, offsetof(mavlink_ivaq_rx_set_params_slave_t, rx_set_update) }, \
         { "rx_set_reset", NULL, MAVLINK_TYPE_UINT8_T, 0, 10, offsetof(mavlink_ivaq_rx_set_params_slave_t, rx_set_reset) }, \
         { "rx_set_anlg_en", NULL, MAVLINK_TYPE_UINT8_T, 0, 11, offsetof(mavlink_ivaq_rx_set_params_slave_t, rx_set_anlg_en) }, \
         { "rx_set_ant_states", NULL, MAVLINK_TYPE_UINT8_T, 0, 12, offsetof(mavlink_ivaq_rx_set_params_slave_t, rx_set_ant_states) }, \
         { "rx_set_stgs_operation", NULL, MAVLINK_TYPE_UINT8_T, 0, 13, offsetof(mavlink_ivaq_rx_set_params_slave_t, rx_set_stgs_operation) }, \
         { "rx_set_stg_states", NULL, MAVLINK_TYPE_UINT8_T, 0, 14, offsetof(mavlink_ivaq_rx_set_params_slave_t, rx_set_stg_states) }, \
         { "rx_set_save_opt", NULL, MAVLINK_TYPE_UINT8_T, 0, 15, offsetof(mavlink_ivaq_rx_set_params_slave_t, rx_set_save_opt) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_IVAQ_RX_SET_PARAMS_SLAVE { \
 ...
 *
 * @param rx_time_px_unix_ms  IVAQ Rx Master time since boot in ms
 * @param rx_set_chg_request  Ivaq Rx Set Change Request
 * @param rx_set_update  Ivaq Rx Set Update Firmware
 ...
 * @param rx_set_stgs_operation  Ivaq Rx Set Stages Operation (automatic/manual)
...
static inline uint16_t mavlink_msg_ivaq_rx_set_params_slave_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t rx_time_px_unix_ms, uint8_t rx_set_chg_request, uint8_t rx_set_update, uint8_t rx_set_reset, uint8_t rx_set_anlg_en, uint8_t rx_set_ant_states, uint8_t rx_set_stgs_operation, uint8_t rx_set_stg_states, uint8_t rx_set_save_opt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_IVAQ_RX_SET_PARAMS_SLAVE_LEN];
    _mav_put_uint64_t(buf, 0, rx_time_px_unix_ms);
    _mav_put_uint8_t(buf, 8, rx_set_chg_request);
    _mav_put_uint8_t(buf, 9, rx_set_update);
    _mav_put_uint8_t(buf, 10, rx_set_reset);
    _mav_put_uint8_t(buf, 11, rx_set_anlg_en);
    _mav_put_uint8_t(buf, 12, rx_set_ant_states);
    _mav_put_uint8_t(buf, 13, rx_set_stgs_operation);
    _mav_put_uint8_t(buf, 14, rx_set_stg_states);
    _mav_put_uint8_t(buf, 15, rx_set_save_opt);
    ...
    packet.rx_time_px_unix_ms = rx_time_px_unix_ms;
...
{
    return mavlink_msg_ivaq_rx_set_params_slave_pack(system_id, component_id, msg, ivaq_rx_set_params_slave->rx_time_px_unix_ms, ivaq_rx_set_params_slave->rx_set_chg_request, ivaq_rx_set_params_slave->rx_set_update, ivaq_rx_set_params_slave->rx_set_reset, ivaq_rx_set_params_slave->rx_set_anlg_en, ivaq_rx_set_params_slave->rx_set_ant_states, ivaq_rx_set_params_slave->rx_set_stgs_operation, ivaq_rx_set_params_slave->rx_set_stg_states, ivaq_rx_set_params_slave->rx_set_save_opt);
}
...
{
    return mavlink_msg_ivaq_rx_set_params_slave_pack_chan(system_id, component_id, chan, msg, ivaq_rx_set_params_slave->rx_time_px_unix_ms, ivaq_rx_set_params_slave->rx_set_chg_request, ivaq_rx_set_params_slave->rx_set_update, ivaq_rx_set_params_slave->rx_set_reset, ivaq_rx_set_params_slave->rx_set_anlg_en, ivaq_rx_set_params_slave->rx_set_ant_states, ivaq_rx_set_params_slave->rx_set_stgs_operation, ivaq_rx_set_params_slave->rx_set_stg_states, ivaq_rx_set_params_slave->rx_set_save_opt);
}
...
{
    return mavlink_msg_ivaq_rx_set_params_slave_pack_status(system_id, component_id, _status, msg,  ivaq_rx_set_params_slave->rx_time_px_unix_ms, ivaq_rx_set_params_slave->rx_set_chg_request, ivaq_rx_set_params_slave->rx_set_update, ivaq_rx_set_params_slave->rx_set_reset, ivaq_rx_set_params_slave->rx_set_anlg_en, ivaq_rx_set_params_slave->rx_set_ant_states, ivaq_rx_set_params_slave->rx_set_stgs_operation, ivaq_rx_set_params_slave->rx_set_stg_states, ivaq_rx_set_params_slave->rx_set_save_opt);
}
...
static inline void mavlink_msg_ivaq_rx_set_params_slave_send(mavlink_channel_t chan, uint64_t rx_time_px_unix_ms, uint8_t rx_set_chg_request, uint8_t rx_set_update, uint8_t rx_set_reset, uint8_t rx_set_anlg_en, uint8_t rx_set_ant_states, uint8_t rx_set_stgs_operation, uint8_t rx_set_stg_states, uint8_t rx_set_save_opt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_IVAQ_RX_SET_PARAMS_SLAVE_LEN];
    _mav_put_uint64_t(buf, 0, rx_time_px_unix_ms);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_ivaq_rx_set_params_slave_send(chan, ivaq_rx_set_params_slave->rx_time_px_unix_ms, ivaq_rx_set_params_slave->rx_set_chg_request, ivaq_rx_set_params_slave->rx_set_update, ivaq_rx_set_params_slave->rx_set_reset, ivaq_rx_set_params_slave->rx_set_anlg_en, ivaq_rx_set_params_slave->rx_set_ant_states, ivaq_rx_set_params_slave->rx_set_stgs_operation, ivaq_rx_set_params_slave->rx_set_stg_states, ivaq_rx_set_params_slave->rx_set_save_opt);
#else
 ...
 */
static inline void mavlink_msg_ivaq_rx_set_params_slave_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t rx_time_px_unix_ms, uint8_t rx_set_chg_request, uint8_t rx_set_update, uint8_t rx_set_reset, uint8_t rx_set_anlg_en, uint8_t rx_set_ant_states, uint8_t rx_set_stgs_operation, uint8_t rx_set_stg_states, uint8_t rx_set_save_opt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field rx_time_px_unix_ms from ivaq_rx_set_params_slave message
 *
 * @return  IVAQ Rx Master time since boot in ms
 */
static inline uint64_t mavlink_msg_ivaq_rx_set_params_slave_get_rx_time_px_unix_ms(const mavlink_message_t* msg)
{
...
/**
 * @brief Get field rx_set_update from ivaq_rx_set_params_slave message
 *
 * @return  Ivaq Rx Set Update Firmware
 */
static inline uint8_t mavlink_msg_ivaq_rx_set_params_slave_get_rx_set_update(const mavlink_message_t* msg)
{
 ...
 *
 * @return  Ivaq Rx Set Stages Operation (automatic/manual)
 */
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    ivaq_rx_set_params_slave->rx_time_px_unix_ms = mavlink_msg_ivaq_rx_set_params_slave_get_rx_time_px_unix_ms(msg);
    ivaq_rx_set_params_slave->rx_set_chg_request = mavlink_msg_ivaq_rx_set_params_slave_get_rx_set_chg_request(msg);
    ivaq_rx_set_params_slave->rx_set_update = mavlink_msg_ivaq_rx_set_params_slave_get_rx_set_update(msg);
