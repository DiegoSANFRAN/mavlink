...
typedef struct __mavlink_ivaq_rx_mini_set_params_t {
 ...
 uint8_t rx_capture_command; /*<  Requested acquisition/transfer action.*/
...
#define MAVLINK_MSG_ID_IVAQ_RX_MINI_SET_PARAMS_CRC 228
#define MAVLINK_MSG_ID_61001_CRC 228
...
#define MAVLINK_MESSAGE_INFO_IVAQ_RX_MINI_SET_PARAMS { \
    ...
    {  { "rx_set_update", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_ivaq_rx_mini_set_params_t, rx_set_update) }, \
         ...
         { "rx_capture_command", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_ivaq_rx_mini_set_params_t, rx_capture_command) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_IVAQ_RX_MINI_SET_PARAMS { \
 ...
 * @param rx_capture_command  Requested acquisition/transfer action.
...
static inline uint16_t mavlink_msg_ivaq_rx_mini_set_params_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t rx_set_update, uint8_t rx_set_reset, uint8_t rx_capture_command)
{
    ...
    _mav_put_uint8_t(buf, 2, rx_capture_command);
    ...
    packet.rx_capture_command = rx_capture_command;
...
{
    return mavlink_msg_ivaq_rx_mini_set_params_pack(system_id, component_id, msg, ivaq_rx_mini_set_params->rx_set_update, ivaq_rx_mini_set_params->rx_set_reset, ivaq_rx_mini_set_params->rx_capture_command);
}
...
{
    return mavlink_msg_ivaq_rx_mini_set_params_pack_chan(system_id, component_id, chan, msg, ivaq_rx_mini_set_params->rx_set_update, ivaq_rx_mini_set_params->rx_set_reset, ivaq_rx_mini_set_params->rx_capture_command);
}
...
{
    return mavlink_msg_ivaq_rx_mini_set_params_pack_status(system_id, component_id, _status, msg,  ivaq_rx_mini_set_params->rx_set_update, ivaq_rx_mini_set_params->rx_set_reset, ivaq_rx_mini_set_params->rx_capture_command);
}
...
static inline void mavlink_msg_ivaq_rx_mini_set_params_send(mavlink_channel_t chan, uint8_t rx_set_update, uint8_t rx_set_reset, uint8_t rx_capture_command)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_IVAQ_RX_MINI_SET_PARAMS_LEN];
    _mav_put_uint8_t(buf, 0, rx_set_update);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_ivaq_rx_mini_set_params_send(chan, ivaq_rx_mini_set_params->rx_set_update, ivaq_rx_mini_set_params->rx_set_reset, ivaq_rx_mini_set_params->rx_capture_command);
#else
 ...
 */
static inline void mavlink_msg_ivaq_rx_mini_set_params_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t rx_set_update, uint8_t rx_set_reset, uint8_t rx_capture_command)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field rx_capture_command from ivaq_rx_mini_set_params message
 *
 * @return  Requested acquisition/transfer action.
 */
static inline uint8_t mavlink_msg_ivaq_rx_mini_set_params_get_rx_capture_command(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_ivaq_rx_mini_set_params_decode(const mavlink_message_t* msg, mavlink_ivaq_rx_mini_set_params_t* ivaq_rx_mini_set_params)
{
    ...
    ivaq_rx_mini_set_params->rx_capture_command = mavlink_msg_ivaq_rx_mini_set_params_get_rx_capture_command(msg);
#else
